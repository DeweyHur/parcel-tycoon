...
// 「인수인계」 런의 1~3개월차를 사람처럼(꽉 차면 호출, 급하면 그냥 호출) 굴려 보고
...
const g = new Game({ scenario: 'standard', company: 'local', perks: [], insurer: 'none', difficulty: diff, story: true, scripted: true, prep: false });
