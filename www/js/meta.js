...
(function (root) {
  ...
  const COMPANIES = {
    ...
    postal: {
      ...
      mods: { premiumDelta: { premier: -30 }, opCostFixed: 180, feeFixed: 45, selfCapDelta: 1, stressRelief: { min: 10, amount: 2 }, marketMaxBuy: 2, expertFrom: 5, bonusDelta: -5, marketWeight: { trusted: 1.3, expert: 0.5, master: 0.5 } },
  ...
  const SCENARIOS = {
    ...
    peak:     { icon: '🎄', months: 2, mods: { eventGoods: true, returnGrace: 2, burstDeadlineDelta: -2, arrivalsMult: 2.2, burstTurns: 5, rewardAll: 10, itemPriceMult: 1.3, startCallsDelta: 2, winDelivered: 50 }, unlock: 'busy_month' },
    ...
    strike:   { icon: '✊', months: 3, mods: { strike: true, arrivalsMult: 1.2, opCostDelta: 30 }, unlock: 'four_carriers' },
