...
(function (root) {
  ...
  const DIFFICULTIES = {
    rookie:  { icon: '🌱', mods: { arrivalsMult: 0.85, opCostDelta: -20, itemPriceMult: 0.9, contractPriceMult: 0.9, facilityPriceMult: 0.9, theftMult: 0.5, breakMult: 0.5, claimMult: 0.5, upcomingTurns: 3, gameoverStress: 24, scoreMult: 0.7, noDualAttrs: true }, unlock: null },
    normal:  { icon: '📦', mods: {}, unlock: null },
    veteran: { icon: '🔥', mods: { arrivalsMult: 1.1, opCostDelta: 30, itemPriceMult: 1.1, contractPriceMult: 1.1, facilityPriceMult: 1.1, theftMult: 1.3, breakMult: 1.3, claimMult: 1.5, gameoverStress: 18, scoreMult: 1.4, dualAttrBonus: 3 }, unlock: 'first_clear' },
  };
  ...
  const PERKS = {
    ...
    emergency: { family: 'ops', mods: { urgentDiscount: 0.7, guaranteeCarrier: 'urgent' }, unlock: 'clutch' },
    // 수익 계열
  ...
  const SCENARIOS = {
    ...
    peak:     { icon: '🎄', months: 2, mods: { eventGoods: true, returnGrace: 2, burstDeadlineDelta: -2, arrivalsMult: 2.0, burstTurns: 5, rewardAll: 10, itemPriceMult: 1.3, startCallsDelta: 2, winDelivered: 42 }, unlock: 'busy_month' },
    heatwave: { icon: '🌡️', months: 3, mods: { season: 'summer', customerWeights: { dawn: 2, ice: 2 }, customerClaimMult: { dawn: 2 }, typeShift: { fresh: 12, produce: 8, normal: -20 }, freshSizes: [2, 4, 7], warmMult: 3, heatAlerts: 3, arrivalsMult: 1.1, facilityPriceMult: { cold1: 0.7, cold2: 0.7 }, marketWeight: { cold: 1.5 }, winMaxDiscard: 3 }, unlock: 'fresh20' },
    strike:   { icon: '✊', months: 3, mods: { strike: true, guaranteeCarrier: 'urgent', arrivalsMult: 1.2, opCostDelta: 30 }, unlock: 'four_carriers' },
    port:     { icon: '🚢', months: 4, mods: { forceCustomers: ['import', 'luxury', 'factory'], noAnon: true, typeOverride: { normal: 40, fresh: 10, produce: 5, fragile: 13, intl: 20, large: 12 }, xlWeight: 7, arrivalsMult: 1.1, rewardDelta: { intl: 20, large: 20, normal: -5 }, xlDelta: 1, guaranteeCarriers: ['intl', 'large'] }, unlock: 'intl15' },
    cashcrunch:{ icon: '💸', months: 3, mods: { cashMult: 0.5, opCostFixed: 240, noRefresh: true, itemPriceMult: 1.1, revenueMult: 1.1, trustXpMult: 2, winCash: 600 }, unlock: 'rich_clear' },
    blackfriday:{ icon: '🛒', months: 1, mods: { returnGrace: 4, arrivalsMult: 2.3, burstTurns: 4, itemPriceMult: 1.4, rewardAll: 15, startCallsDelta: 3, winDelivered: 22 }, unlock: 'peak_clear' },
    audit:    { icon: '📋', months: 3, mods: { premiumMult: 1.5, claimMult: 1.5, deadlineAll: -1, overdueMult: 0.5, monthlyStress: 1, opCostDelta: 30, winMaxOverdue: 4 }, unlock: 'perfect_month' },
    moving:   { icon: '🚚', months: 3, mods: { forceCustomers: ['mover'], storageOfferEvery: 5, storageOfferProb: 0.2, storageMax: 3, storageFeeMult: 1.5, season: 'spring', winStorage: 6 }, unlock: 'storage3' },
  ...
  const ACHIEVEMENTS = {
    ...
    clutch:       { kind: 'run', rewardType: 'perk', reward: 'emergency', check: s => s.urgentClutch },
