...
(function (root) {
  ...
  const SCENARIOS = {
    ...
    port:     { name: '항만 계약', icon: '🚢', months: 4, desc: '국제 20%·대형 12%, 초대형 7%, 입고 +10%. 국제·대형 보상 +20, 일반 -5', win: '4개월 생존', mods: { typeOverride: { normal: 40, fresh: 15, fragile: 13, intl: 20, large: 12 }, xlWeight: 7, arrivalsMult: 1.1, rewardDelta: { intl: 20, large: 20, normal: -5 }, xlDelta: 1, guaranteeCarriers: ['intl', 'large'] }, unlock: 'intl15', recommend: '글로벌 · 강철 창고' },
  ...
  const ACHIEVEMENTS = {
    ...
    worldwide:    { name: '세계로', desc: '국제운송 누적 30개 처리', kind: 'cum', rewardType: 'company', reward: 'global', check: (s, p) => p.deliveredByType.intl >= 30, prog: p => [p.deliveredByType.intl, 30] },
    ...
    intl15:       { name: '국제 열다섯', desc: '국제운송 누적 15개 처리', kind: 'cum', rewardType: 'scenario', reward: 'port', check: (s, p) => p.deliveredByType.intl >= 15, prog: p => [p.deliveredByType.intl, 15] },
