...
(function (root) {
  ...
  // 안 대리(살살 택배): 20대 · 곱슬 · 주황 앞치마 · 뽁뽁이 롤
  ...
  const REPS = {
    ...
    ahn_neutral: 'data:image/png;base64,',
    ahn_neutral_talk: 'data:image/png;base64,',
    ahn_smile: 'data:image/png;base64,',
  };
  const CHARACTER = { id: 'park', nameKey: 'story.name' };
  const REP_NAMES = { yeo: 'story.name.yeo', noh: 'story.name.noh', kang: 'story.name.kang', han: 'story.name.han', rep: 'story.name.rep', ahn: 'story.name.ahn' };
  ...
  const BEATS = [
    ...
    { id: 'callModal', months: [1, 2], kind: 'modal', modal: 'call', when: (g, ctx) => ctx.sel === 0 && ctx.elig > 0, pages: [{ expr: 'neutral', hl: '#call-head .load-visual' }, { expr: 'neutral', hl: '#call-head .load-visual' }, { expr: 'neutral', hl: '#parcels', gate: true }] },
    ...
    { id: 'callGo', months: [1, 2], kind: 'modal', modal: 'call', when: (g, ctx) => ctx.sel > 0, pages: [{ expr: 'smile', hl: '#parcels' }, { expr: 'neutral', hl: '#wait-btn', gate: true }] },
