...
(function (root) {
  ...
  ui: {
    ...
    'ps.noDeadline': 'no due date',
    'story.l1due.1': 'From this week we send urgent ones too.<br>Anything with a date has to go out by then.',
    'story.l1due.2': 'See it? The ⏳ is on now — that number is days left.<br>Nothing was urgent until now, so nothing had one.',
