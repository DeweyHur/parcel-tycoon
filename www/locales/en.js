...
(function (root) {
  ...
  ui: {
    ...
    'ct.body': 'The price of the property is set at {price}c. A deposit of {down}c was received today.<br>The balance of {rest}c is due within the remaining ten months, without interest.<br>The buyer shall send out what comes in, on the day it is due. There are no other terms.',
    'ct.stamp': 'Press the seal',
    'ct.price': 'Price',
    'ct.down': 'Deposit (today)',
    'ct.rest': 'Balance (ten months)',
    'ct.after': 'Balance <b>{rest}c</b> within ten months — you start with {left}c.',
    'ct.stampMark': '韓',
