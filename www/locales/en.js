...
(function (root) {
  ...
  ui: {
    ...
    'how.2.d': 'A truck costs the same <b>every time you call it</b>. Two parcels on your starting 7-cell truck: 32c each. A full load: 16c each. If it is <b>not even half full, close today and receive the next arrivals</b> — that is often the smart play.',
