...
(function (root) {
  ...
  ui: {
    ...
    'log.monthStart': '── {cal}/{y} · Month {m} begins ──',
    ...
    'log.storagePerTurn': '{perTurn}c per 2 days, paid at pickup',
    ...
    'log.wait': 'Wait: two days pass without a call',
    ...
    'fmt.date': '{cal}/{a}–{b}',
    'fmt.dayRange': '{a}–{b}',
    'log.weekend': '🛌 Weekend ({a}–{b}) — {choice}{extra}',
    ...
    'wk.title': '🛌 Weekend',
    'wk.head': 'Month {cal}, days {a}–{b}',
    'wk.sub': 'No carriers run on weekends and deadlines are on hold (they count business days) — but <b>anything left in the yard takes one more theft roll</b>.',
    ...
    'wk.overtime.d': '+2 self-deliveries next business day · stress +1',
    'wk.overtime.done': 'worked the weekend',
    'wk.parttime': 'Weekend guard',
    'wk.parttime.d': '{cost}c · no theft this weekend',
    ...
    'offer.perTurn': '{perTurn}c per 2 days at pickup ({total}c)',
