...
(function (root) {
  ...
  ui: {
    ...
    'story.callReady.2': "'Auto-pick urgent' loads the most urgent ones first. Cells left? Add one. Over? Take one off.<br>A second truck means a second dispatch fee.",
    ...
    'story.rain.1': 'Rain in the forecast. Parcels in the yard get wet: −20% pay. Cold and frozen don\'t care.',
    'story.rain.2': 'Tap Wait and there\'s a loading screen — choose what stays inside and what goes out.<br>On rainy days, keep the pricey stuff in.',
