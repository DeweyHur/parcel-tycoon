...
(function (root) {
  ...
  ui: {
    ...
    'media.trait.flyer': "Mostly standard",
    'media.trait.sns': "Fresh · produce ↑",
    'media.trait.radio': "Even mix",
    'media.trait.bus': "Large · fragile ↑",
    'media.line': "+{n} parcels within {days} days · run {cost}c",
    'media.upLine': "+{n} → +{n2} parcels · run {cost}c → {cost2}c",
    'media.newHead': "Advertising",
    'media.run': "Run",
    'media.more': "New media and upgrades are in the market",
    'growth.fleet': "Fleet",
