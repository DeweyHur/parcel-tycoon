...
(function (root) {
  ...
  ui: {
    ...
    'story.callModal.1': "Tap 'Auto-pick urgent'. It loads the most urgent ones first.<br>Cells left? Add one. Over? Take one off. A second truck means a second dispatch fee.",
    ...
    'story.rain.2': 'Tap Wait. There\'s a Reorder button in there — choose what stays inside and what goes out.',
