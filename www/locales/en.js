...
(function (root) {
  ...
  ui: {
    ...
    'intro.2': 'A depot that ran for twenty years shuts at the end of this month.',
    'intro.3': 'The owner wanted it closed. I said I would try.',
    'intro.4': 'Today is day one.',
    'intro.skip': 'Skip ▸',
    'story.name.mart': 'Kim, Big Mart',
    'story.l1intro.4': 'That\'s today\'s intake. The warehouse fills up every single working day.',
    'story.l1intro.5': 'Yeo from Hangil Logistics. You\'re the new boss?<br>Call us when you need a truck — we\'re your only contract right now.',
    ...
    'story.l1last.2': 'This place still has no name — I took the old owner\'s sign down.<br>Get through this month and put one up.',
    'story.l1intro.1': 'You made it. Not late on your first day, good.<br>I\'m Park. Warehouse manager here… was, anyway.',
    'story.l1intro.2': 'This place is yours as of today.<br>Twenty years I ran it, and this month I hit retirement.',
    'story.l1intro.3': 'The owner wanted to shut it down. You said you\'d give it a go, so I pushed for you.<br>On the condition I stay two months to show you the ropes.',
    ...
    'story.l1last.1': 'Last two weeks already. You\'re quicker than me now.',
    'lv.ch.1': 'Prologue',
    'lv.ch.2': 'Chapter 1',
    'lv.ch.3': 'Chapter 2',
    'lv.ch.4': 'Chapter 3',
    ...
    'lv.nameAsk': 'Time this place had a name',
    'lv.nameBody': 'Two months in, it\'s your shop now. What goes on the sign?',
