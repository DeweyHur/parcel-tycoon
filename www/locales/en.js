...
(function (root) {
  ...
  ui: {
    ...
    'log.wait': 'Wait: a day passes without a call',
    ...
    'how.2.d': 'A truck costs the same <b>every time you call it</b>. Two parcels on your starting 7-cell truck: 32c each. A full load: 16c each. <b>Below half full, calling loses money</b> — waiting is often the right move.',
    ...
    'story.intro.2': 'Those are today\'s parcels. Every one of them is money — but left like that, they just fill the warehouse.<br>See the ⏳? Four business days to ship. March is moving season, so it\'s mostly plain boxes.',
    ...
    'intro.1': 'Monday, March 2nd, 2027.',
    'intro.2': 'This depot has an owner.',
    'intro.3': 'Han Jong-su. Started at forty with one handcart, he says.',
    'intro.4': 'I first came at sixteen, running my father’s errand.',
    'intro.8': '“Run it for one year. If it suits you, I’ll sell it to you cheap.”',
    'intro.9': 'So: twelve months, starting today.',
    'intro.10': 'Not on my own, though. Foreman Park is in it for the whole year.',
    'intro.11': 'Today is day one.',
    'card.han.name': 'Han Jong-su',
    'card.han.desc': 'Owner of this depot',
    'card.park.name': 'Foreman Park',
    'card.park.desc': 'Yard chief here',
    'intro.skip': 'Skip ▸',
    'intro.5': 'After that I came whenever they were short-handed.<br>Unloading together, eating noodles together.',
    'intro.6': 'He never paid me for it. I never thought to ask.',
    'intro.7': '“I can’t lift these any more,” he said last winter.',
    'story.name.han': 'Mr. Han',
    'story.name.mart': 'Kim, Big Mart',
    'story.l1intro.4': 'So sending it now loses you <b>{nowLoss}c</b>.<br>The fee is {nowFee}c whether you load one cell or {nowCap}.',
    'story.l1intro.5': 'See? So today you <b>wait</b>.<br>Let it pile up, then send a full truck. That is the job.',
    'story.l1first.3': 'Fuller truck, bigger share. For now that\'s the whole job.',
    'story.l1last.2': 'I’ll write the two months up for Mr. Han.<br>What I put in it… depends on how you finish.',
    'story.l1intro.1': 'There you are. Mr. Han told me.<br>I\'m Foreman Park. We do this year together.',
    'story.l1intro.2': 'Yeo, Hangil Logistics. Just dropped by to say hello.<br>Calling a truck today?',
    'story.l1intro.3': 'Our truck holds <b>{nowCap}</b>, and one call costs <b>{nowFee}c</b>.<br>You have {nowVol} in there — worth {nowRev}c.',
    'story.l1call.1': 'Now it is worth calling. That button says <b>{readyVol}/{readyCap}</b>.',
    'story.l1call.2': 'Call now and you take {nowRev}c against a {nowFee}c fee — <b>{nowNet}c left.</b><br>Same {nowFee}c as day one. Go on.',
    'story.l1callPick.1': 'That gauge up top is how full the truck is.',
    'story.l1callPick.2': 'Hit <b>\'Auto-pick urgent\'</b>. It loads the urgent ones until the truck is full.',
    'story.l1callGo.1': 'Then call it. Calling takes the day.',
    ...
    'story.l1free.1': 'That\'s the basics. Pile up, then call. Otherwise wait.<br>Rest is yours — I\'ll be watching.',
    ...
    'story.l1sunday.1': 'Sunday is off. Nothing arrives and no deadline moves.',
    'story.l1sunday.2': 'Get some rest. See you Monday.',
    ...
    'story.l2intro.1': 'Two months done. Seal pressed. The sign out front is yours now.<br>So let\u2019s talk about running the place properly.',
    'story.l2intro.2': 'See that <b>{trucks} dispatches</b> under the contract card? That wasn\u2019t there in the prologue.',
    'story.l2intro.3': 'Every time you call a truck, that goes down by one.<br>Mr. Han paid ahead for exactly that many.',
    ...
    'story.l2market.2': 'Refills, contract limits, warehouse space \u2014 what\u2019s on offer shifts month to month,<br>and there\u2019s a cap on how much you can buy in one.',
    ...
    'story.l3rain.2': 'Press wait. You can move things in and out.',
    ...
    'story.l3self.1': 'No truck. That\u2019s what <b>self-delivery</b> is for \u2014 on a waiting day I carry one myself.',
    'story.l3self.2': 'Costs a bit, but it beats a return. Press wait.',
    ...
    'story.l6full.1': 'Hold on. <b>All four contract slots are taken.</b> Nowhere to put another.',
    'story.l6full.2': 'Then it isn\u2019t a contract you want, it\u2019s a <b>clause</b> \u2014 an extra term fitted to a contract you already have.<br>Takes no slot. One clause per contract, mind.',
    'story.l6full.3': 'Buy that and fit it to the right contract; that truck will take \u2746 as well.<br>Last thing I\u2019ll teach you: when you\u2019re out of room, you don\u2019t add \u2014 you <b>fit</b>.',
    ...
    'story.l1last.1': 'Last half-month already. You’re quicker than me now.',
    'rpt.title': '{ch} — Report',
    'rpt.by': 'Foreman Park\'s write-up',
    'rpt.sub': '{months} months, going to Mr. Han',
    'rpt.delivered': 'Delivered',
    'rpt.onTime': 'On time',
    'rpt.trouble': 'Returned / spoiled',
    'rpt.cash': 'Cash left',
    'rpt.unit': '{n}',
    'rpt.good': '"Took to it well. Dropped nothing, barely a late one.<br>Twenty years here and I have not seen a first two months like it."',
    'rpt.ok': '"Serviceable. A few ran late, but they knew why they were late.<br>That means they are learning."',
    'rpt.bad': '"Hands not broken in yet. Dropped a few.<br>Did not run off, though. That counts for something."',
    'rpt.next': 'Read Mr. Han\'s letter',
    'letter.title': 'A letter from Mr. Han',
    'letter.toName': 'To {name}',
    'letter.toYou': 'To you',
    'letter.sign': 'Han Jong-su',
    'letter.close': 'Fold it away',
    'letter.generic.good': 'Park\'s handwriting came with the two months. I liked his tone better than the numbers.<br><br>I bought this depot at forty. One handcart, that was all.<br>Where you stand now is where I stood at forty. Nothing to it, is there? There never was.<br><br>Two more months, if you please.',
    'letter.generic.bad': 'Park\'s handwriting came with the two months. Says you dropped a few.<br><br>That\'s all right. My first year I left a whole household\'s move out in the rain.<br>That woman became a customer for twenty years. A proper apology does that.<br><br>Two more months, if you please.',
    'letter.2.good': 'Another two months in Park\u2019s hand. He writes that you send them full.<br><br>That\u2019s dispatches for you \u2014 you buy them, and what you don\u2019t use simply goes.<br>Took me three years to see it. Two months for you.<br><br>Got a sign up yet? No hurry.',
    'letter.2.bad': 'Two months received. Some sat because there was no truck to call.<br><br>That isn\u2019t a fault, it\u2019s a sum you hadn\u2019t done yet. You only get caught once.<br><br>Eight months left. Keep at it.',
    'letter.3.good': 'You got through the rains. Nothing left out and soaked, he writes.<br><br>My first year I put a whole household\u2019s move under the rain. That woman became a twenty-year customer,<br>but that was luck. Your way is the right one.<br><br>After summer the freight changes. Listen to Park.',
    'letter.3.bad': 'Two months received. Some of it got wet.<br><br>That\u2019s what happens under no roof. The yard is only ever temporary.<br>Widen the warehouse or send more often \u2014 your choice which.<br><br>Six months to go.',
    'letter.4.good': 'Autumn\u2019s in. Not a single cold item spoiled.<br><br>People put off chilling because it costs. One spoiled load costs more.<br>You\u2019ve already done that sum.<br><br>Several shippers named in here, too. People are sticking.',
    'letter.4.bad': 'Two months received. Some spoiled.<br><br>Cold freight won\u2019t wait. Took me a whole summer to learn that.<br><br>Four months left, and the busy season\u2019s here.',
    'letter.5.good': 'Year-end\u2019s in. Not one dropped out of all that volume.<br><br>I\u2019ll admit I\u2019m surprised. November and December cost me a few every single year.<br>Them knowing your name round here isn\u2019t just talk now.<br><br>Clear the New Year and it\u2019s done.',
    'letter.5.bad': 'Year-end received. A few dropped.<br><br>Those two months are like that. Twenty years and I never once came through them clean.<br>What matters is that you\u2019re still there.<br><br>One New Year left.',
    'letter.6.good': 'And the New Year too.<br><br>A whole year round. I still remember your face that first day in March \u2014<br>didn\u2019t look like you could pull a handcart.<br><br>It isn\u2019t my depot any more. Congratulations.',
    'letter.6.bad': 'And the New Year too.<br><br>A few dropped, he writes, but going the whole year round is the thing.<br>I dropped far more my first year.<br><br>It isn\u2019t my depot any more. Congratulations.',
    'letter.1.good': 'Park\'s handwriting came with the two months. Says you dropped nothing.<br><br>Honestly, I thought you\'d give up after a month.<br>I still remember your face at sixteen, running your father\'s errand. You make that face whenever you lift something heavy.<br><br>Ten months to go. Keep at it.',
    'letter.1.bad': 'Park\'s handwriting came with the two months. Says you dropped a few.<br><br>My first year I left a whole household\'s move out in the rain. That woman became a customer for twenty years.<br>It isn\'t the ones who never slip who learn the trade. It\'s the ones who don\'t run off.<br><br>Ten months to go. Keep at it.',
    'lv.nextCh': '{ch} opens soon.',
    'ct.modal': 'Contract',
    'ct.title': 'C O N D I T I O N A L   S A L E',
    'ct.seller': 'Seller',
    'ct.sellerName': 'Han Jong-su',
    'ct.buyer': 'Buyer',
    'ct.item': 'Property',
    'ct.itemName': 'One neighbourhood depot, with yard',
    'ct.body': 'The price of the property is set at {price}c. A deposit of {down}c was received today.<br>The balance of {rest}c is paid in instalments, one every two months, within the remaining ten. No interest.<br>The buyer shall send out what comes in, on the day it is due. There are no other terms.',
    ...
    'ct.bodyFinal': 'The price has been received in full. The seller hands the property over completely.<br>A whole year and nothing spilled. That will do.',
    'ct.doneFinal': 'Take the depot',
    'ct.stamp': 'Press the seal',
    'ct.price': 'Price',
    'ct.down': 'Deposit (today)',
    'ct.rest': 'Balance (paid every two months)',
    'ct.after': 'Balance <b>{rest}c</b> in instalments — you start with {left}c.',
    'ct.stampMark': '韓',
    'ct.done': 'Take the depot',
    'lv.sub.1': 'The Empty Depot',
    'lv.sub.2': 'The Second Truck',
    'lv.sub.3': 'Monsoon',
    'lv.sub.4': 'Cold Freight',
    'lv.sub.5': 'Word Gets Around',
    'lv.sub.6': 'Last Winter',
    'ch.when': 'M{a}\u2013M{b}, {y}',
    'ch.tap': 'Tap to begin',
    'ch.tapNext': 'Tap to continue',
    'ch.endTitle': '{ch} \u00b7 End',
    'ch.nextLabel': 'Next',
    'ch.soon': 'coming soon',
    'ch.end.1': 'The shutter goes up by my own hand now.',
    'ch.end.2': 'One more truck standing in the yard.',
    'ch.end.3': 'The rain stopped, and the yard dried.',
    'ch.end.4': 'The cold freight found its place.',
    'ch.end.5': 'The name travelled past the neighbourhood.',
    'ch.end.6': 'The last of the New Year freight went out.',
    'lv.ch.1': 'Prologue',
    'lv.ch.2': 'Chapter 1',
    'lv.ch.3': 'Chapter 2',
    'lv.ch.4': 'Chapter 3',
    ...
    'lv.nameBody': 'Two months in, time you put a sign up. I\'ll take a fair price for the place.<br>What shall we write on the contract?',
    'lv.namePlaceholder': 'Company name',
    'lv.nameSave': 'That\'s the one',
    'lv.nameDefault': 'Hangil Delivery',
    'lv.next': 'The next level is in the works — the Handover and free runs are unlocked for now.',
    'lv.start': 'Start',
    'lv.startSub': '{ch}',
    'lv.continue': 'Continue',
    'lv.restart': 'Restart',
    'lv.pickAsk': 'Replay {ch} from the start. Your run in progress will be lost.',
    'lv.pickGo': 'Replay',
    'lv.doneGo': 'Next',
    'sum.toNext': 'Start {n}',
    'help.l1': '<b>The whole job</b><br>Parcels arrive every business day. Pile them up and send <b>a full truck</b> — the fuller it goes, the cheaper each parcel gets.<br><br><b>Deadline</b> Every parcel has a ⏳. Miss it and the pay drops; two days more and it goes back.<br><b>Wait</b> A day you don\'t call a truck. The day passes and more parcels arrive.<br><b>Warehouse</b> When it fills up, the rest piles in the yard.<br><b>Sunday</b> A day off. No arrivals, no deadlines moving.<br><b>Settlement</b> Every two weeks, income minus dispatch fees and rent.<br><br><span style=\'color:var(--dim)\'>The manager will tell you the rest as it comes up.</span>',
