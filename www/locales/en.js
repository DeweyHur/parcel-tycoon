...
(function (root) {
  ...
  ui: {
    ...
    'story.l1intro.2': "One call to Hangil is <b>{nowFee}c</b>. The depot only holds {nowVol} slots right now — that pays {nowRev}c, so you'd be <b>{nowLoss}c down</b>.<br>One crate or a full deck, the fee is the same. You stack, then you send it full. Today you <b>wait</b>.",
