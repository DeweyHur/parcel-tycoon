...
(function (root) {
  ...
  ui: {
    ...
    'story.l1intro.2': 'Yeo, from Hangil Logistics. <b>{nowFee}c</b> a call.<br>See that? The second number is what one truck takes; the first is what would go now.',
    'story.l1intro.3': 'Call now and you\'re <b>{nowLoss}c down</b> — one crate or a full deck, the fee is the same.<br>You stack, then you send it full. Today you <b>wait</b>.',
    ...
    'letter.2.good': 'He writes that you send them full.<br><br>Dispatches are bought, and unused ones simply go. Top them up before they run out.',
    'letter.2.bad': 'Some sat because there was no truck to call.<br><br>Dispatches are bought. Run out and a whole day goes empty — top them up early.',
    ...
    'letter.1.good': 'Park tells me you sent them full.<br><br>That is the whole of it — one crate or a full deck, the fee is the same.',
    'letter.1.bad': 'Park tells me some went out half empty.<br><br>It happens when you are pressed. But the fee is the same, so full always pays better.',
