...
(function (root) {
  ...
  ui: {
    ...
    'how.2.d': 'A truck costs the same <b>every time you call it</b>. Two parcels on your starting 7-cell truck: 51c each. A full load: 26c each. <b>Below 80% full, calling loses money</b> — waiting is often the right move.',
    ...
    'story.callReady.2': 'So the fuller you send it, the cheaper each parcel gets — past 80% you\'re not losing money.<br>Tap {ready}. I\'ll point at what to press in there.',
