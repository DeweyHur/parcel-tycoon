...
(function (root) {
  ...
  ui: {
    ...
    'story.l1intro.2': "One call to Hangil is <b>{nowFee}c</b> — the same {nowFee}c whether you load one crate or fill the deck.<br>Right now the depot holds {nowCount}, and sending all of them pays <b>{nowRev}c</b>.<br>Paying {nowFee}c to collect {nowRev}c leaves you <b>{nowLoss}c down</b>. So today you <b>wait</b>.",
