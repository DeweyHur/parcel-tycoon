...
(function (root) {
  ...
  ui: {
    ...
    'story.intro.3': 'A {name} truck costs {fee}c whether it carries one box or groans at the axle.<br>Ship timidly and fees bleed you dry. Wait too long and the depot bursts. <b>Stockpile, calculate, detonate.</b> Today, wait.',
    ...
    'story.l1intro.3': 'Send now and you are <b>{nowLoss}c down</b>. Panic-ship one box at a time and fees bleed you dry.<br>But wait too long and the depot bursts. Stack to that edge, then <b>sweep it out in one hit</b>. Today, wait.',
