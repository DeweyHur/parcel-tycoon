...
(function (root) {
  ...
  ui: {
    ...
    'title.goal': 'Take over in March — a quarter, a half-year, or the whole year',
    ...
    'intro.3': 'Han Jong-su. Eighty-two. Started at forty with one handcart, he says.',
    ...
    'card.han.desc': 'Owner of this depot · 82',
    'card.park.name': 'Foreman Park',
    'card.park.desc': 'Yard chief here · twenty years',
    'intro.skip': 'Skip ▸',
    ...
    'story.l1intro.4': 'That\'s today\'s intake. The warehouse fills up every single working day.',
    'story.l1intro.5': 'Yeo, Hangil Logistics. You’re the one taking over?<br>Call us when you need a truck — we’re your only contract for now.',
    'story.l1intro.6': 'See? Call and they come. But every call costs money.<br>So don\'t call today. Pile them up and send a full truck — that\'s the job. Today you <b>wait</b>.',
    'story.l1mart.1': 'Kim, from Big Mart. We\'re sending our parcels here from today.<br>Keep to the deadlines and we\'ll keep sending.',
    'story.l1mart.2': 'Our regular. Right now their goods are pretty much all of it.<br>Ship them well and they keep coming — that\'s the whole trade.',
    ...
    'story.l1intro.1': 'There you are. Mr. Han told me.<br>You\'re running the place from today.',
    'story.l1intro.2': 'I\'m Foreman Park. Twenty years of taking goods in and sending them out, right here.',
    'story.l1intro.3': 'Mr. Han asked me to stay at your elbow.<br>Nowhere else for me to be — we do this year together.',
    'story.l1waitGo.1': 'Hit <b>Just wait</b> here.',
    'story.l1call.1': 'Now it\'s worth calling. See <b>{readyVol}/{readyCap} cells</b> on that button?',
    'story.l1call.2': 'One truck holds {readyCap}. The fuller it goes, the cheaper each parcel gets. Tap it.',
    ...
    'story.l1deadline.1': 'That one\'s due tomorrow. Miss it and the pay drops; two more days and it goes back.',
    ...
    'ct.modal': 'Contract',
    'ct.title': 'B I L L   O F   S A L E',
    'ct.seller': 'Seller',
    'ct.sellerName': 'Han Jong-su',
    'ct.buyer': 'Buyer',
    'ct.item': 'Property',
    'ct.itemName': 'One neighbourhood depot, with yard',
    'ct.body': 'The seller hands the property to the buyer. The price has already been paid, over one year, in work.<br>The buyer shall send out what comes in, on the day it is due. There are no other terms.',
    ...
    'lv.nameBody': 'You ran the whole year. It isn\'t my depot any more, it\'s yours.<br>What shall we write on the contract?',
    ...
    'pd.arrivedAgo': 'arrived {n#d:# day|# days} ago',
