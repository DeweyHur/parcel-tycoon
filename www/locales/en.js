...
(function (root) {
  ...
  ui: {
    ...
    'ct.body': 'The price of the property is set at {price}c. A deposit of {down}c was received today.<br>The balance of {rest}c is paid in instalments, one every half-month, within the remaining ten. No interest.<br>The buyer shall send out what comes in, on the day it is due. There are no other terms.',
    ...
    'lv.sub.3': 'Spring Rain',
    'lv.sub.4': 'Cold Freight',
    'lv.sub.5': 'Word Gets Around',
    'lv.sub.6': 'Last of Spring',
    'ch.when': 'M{a}\u2013M{b}, {y}',
    'ch.whenHalf': 'M{cal} {half}, {y}',
    'ch.tap': 'Tap to begin',
    ...
    'ch.end.3': 'The spring rain stopped, and the yard dried.',
    'ch.end.4': 'The cold freight found its place.',
    'ch.end.5': 'The name travelled past the neighbourhood.',
    'ch.end.6': 'Spring is done. The shutter is wholly mine now.',
    'lv.ch.1': 'Prologue',
    'lv.ch.2': 'Chapter 1',
    'lv.ch.3': 'Chapter 2',
    'lv.ch.4': 'Chapter 3',
