...
(function (root) {
  ...
  ui: {
    ...
    'intro.2': 'Forty-two applications. Not one offer.',
    'intro.3': 'Day labour, because there was nowhere else to be.',
    'intro.4': 'Mr. Han. Started with one handcart, they said.',
    'intro.8': 'Today is day one.',
    'card.han.name': 'Mr. Han',
    'card.park.name': 'Foreman Park',
    'intro.skip': 'Skip ▸',
    'intro.5': 'Last winter he said it. — “I’d like to hand it to you.”',
    'intro.6': '“Learn it here, run it well. I’ll let it go cheap.”',
    'intro.7': 'Foreman Park. The one unloading beside me every dawn.',
    ...
    'story.l1intro.3': 'Send it now and you\'re <b>{nowLoss}c down</b> — one crate or a full deck, the fee is the same.<br>You stack, then you send it full. Today you <b>wait</b>.',
