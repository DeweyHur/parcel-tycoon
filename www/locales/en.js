...
(function (root) {
  ...
  ui: {
    ...
    'story.callModal.1': 'The button said <b>{openCap} cells · {openFee}c · {openVol} eligible</b>, remember?<br>One truck holds {openCap}, each truck you call costs {openFee}c, and {openVol} cells of parcels can ride this contract right now. The gauge above draws that out.',
