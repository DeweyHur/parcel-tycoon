...
(function (root) {
  ...
  ui: {
    ...
    'rush.preview': 'DOCK RUSH! Reward ×{mult} · bonus +{bonus}c',
    'rush.toast': '🔥 DOCK RUSH! {n} parcels cleared · bonus +{bonus}c',
    'rush.float': '🔥 DOCK RUSH +{n}c',
    ...
    'mission.amount': 'Mission {now}/{target}c',
    ...
    'why.rush': 'a successful Dock Rush dispatch',
    ...
    'call.autoTrim': 'Loaded full trucks only. To send more, pick by hand or use self-delivery when ending the day.',
    ...
    'story.rushReady.2': 'Dock Rush adds two temporary truck slots. Fill several trucks and clear it in one hit for 35% more. Miss, and all you keep is the overflow.',
    'story.rushHit.1': 'Hear that? Shutters, engines, and payment alerts all at once. <b>That is a Dock Rush.</b>',
    ...
    'story.usage76.2': 'See \'Incoming\' up top? It shows what arrives in the next two turns.<br>Use that to decide whether to end the day or call a truck.',
    ...
    'intro.1': 'For twenty years one man raised this shutter.',
    'intro.2': 'Mr. Han. Started with a single handcart.',
    'intro.3': 'I unloaded under him.',
    'intro.4': 'Last winter. — “You raise it now.”',
    'card.han.name': 'Mr. Han',
    'intro.skip': 'Skip ▸',
    'intro.5': '“Run it well and I’ll let it go cheap.”',
    'intro.6': 'There was nowhere else for me to be.',
    ...
    'story.l1progress.1': 'Watch the mission grade below. This month\'s earnings move you from D through C and B to A.',
    'story.l1progress.2': 'That load was over 80%, so PERFECT LOAD is armed. Fill the next one too and the chain starts paying.',
    'story.l1chainHit.1': 'That\'s it! Consecutive full dispatches activated the chain multiplier.',
    'story.l1chainHit.2': 'Chain income also fills the mission meter. One good decision pulls the next reward closer.',
    'story.progressHud.1': 'Mission grade is this month\'s earnings scorecard. C, B and A each pay growth cash immediately.',
    'story.progressHud.2': 'Keep dispatches over 80% to grow PERFECT LOAD. Waiting or sending a light truck breaks the chain.',
    'story.chainHit.1': 'Chain success! Keep making the same good call and every reward gets larger.',
    'story.chainHit.2': 'Chain bonuses accelerate the mission grade too. Push all the way to A.',
    'story.l1last.2': 'I\'ll write this fortnight up for Mr. Han.<br>What I put in it… depends on how you finish.',
    'story.l1intro.1': 'There you are. Mr. Han told me.<br>From today it isn\'t just unloading. Stay close and watch.',
    'story.l1intro.2': 'Yeo, from Hangil Logistics.<br>Our truck holds <b>{nowCap}</b>, <b>{nowFee}c</b> a call. You\'ve got {nowVol} on the floor.',
    'story.l1intro.3': 'Send now and you are <b>{nowLoss}c down</b>. Panic-ship one box at a time and fees bleed you dry.<br>But hold too long and the depot bursts. Stack to that edge, then <b>sweep it out in one hit</b>. Close up for today.',
    ...
    'story.l1free.1': 'That\'s the basics. Pile up, then call. When today\'s work is done, end the day and receive the next arrivals.<br>Rest is yours — I\'ll be watching.',
    ...
    'story.l2intro.1': 'First fortnight done. Seal pressed. The sign out front is yours now.<br>So let\'s talk about running the place properly.',
    ...
    'story.l2rushReady.1': 'The depot is on fire. Dock Rush is ready — two extra trucks can join this dispatch.',
    'story.l2rushReady.2': 'Fill several and clear the floor in one hit for 35% more. Fail to clear it and the next arrivals bury the yard. Your call.',
    'story.l2rushHit.1': 'Yes — that! You just turned an entire warehouse into cash.',
    'story.l2rushHit.2': 'Next time, pull in more with marketing, hold more with storage, and attach more trucks. You are not shipping boxes now. <b>You are building the blast.</b>',
    ...
    'letter.generic.good': 'Park\'s handwriting came with the fortnight. I liked his tone better than the numbers.<br><br>I bought this depot at forty. One handcart, that was all.<br>Where you stand now is where I stood at forty. Nothing to it, is there? There never was.<br><br>Another fortnight, if you please.',
    'letter.generic.bad': 'Park\'s handwriting came with the fortnight. Says you dropped a few.<br><br>That\'s all right. My first year I left a whole household\'s move out in the rain.<br>That woman became a customer for twenty years. A proper apology does that.<br><br>Another fortnight, if you please.',
    'letter.2.good': 'Another fortnight in Park\'s hand. He writes that you send them full.<br><br>That\'s dispatches for you — you buy them, and what you don\'t use simply goes.<br>Took me three years to see it. A fortnight for you.<br><br>Got a sign up yet? No hurry.',
    'letter.2.bad': 'A fortnight received. Some sat because there was no truck to call.<br><br>That isn\'t a fault, it\'s a sum you hadn\'t done yet. You only get caught once.<br><br>Two months left. Keep at it.',
    'letter.3.good': 'You got through the spring rains. Nothing left out and soaked, he writes.<br><br>My first spring I put a whole household\'s move under the rain. That woman became a twenty-year customer,<br>but that was luck. Your way is the right one.<br><br>Come the moving season the freight changes. Listen to Park.',
    'letter.3.bad': 'A fortnight received. Some of it got wet.<br><br>That\'s what happens under no roof. The yard is only ever temporary.<br>Widen the warehouse or send more often — your choice which.<br><br>A month and a half to go.',
    'letter.4.good': 'The moving-season fortnight came in. Not a single cold item spoiled.<br><br>People put off chilling because it costs. One spoiled load costs more.<br>You\'ve already done that sum.<br><br>Several shippers named in here, too. People are sticking.',
    'letter.4.bad': 'A fortnight received. Some spoiled.<br><br>Cold freight won\'t wait. Took me a whole spring to learn that.<br><br>One month left, and the busy stretch is here.',
    'letter.5.good': 'The first half of May came in. Not one dropped out of all that volume.<br><br>I\'ll admit I\'m surprised. Family month costs me a few every single year.<br>Them knowing your name round here isn\'t just talk now.<br><br>One more fortnight and it\'s done. Stay with it to the end.',
    'letter.5.bad': 'The first half of May received. A few dropped.<br><br>That fortnight is like that. Twenty years and I never once came through it clean.<br>What matters is that you\'re still there.<br><br>One last fortnight left.',
    'letter.6.good': 'You saw it through.<br><br>A whole spring round. I still remember your face that first day in March —<br>didn\'t look like you could pull a handcart.<br><br>It isn\'t my depot any more. Congratulations.',
    'letter.6.bad': 'You saw it through.<br><br>A few dropped, he writes, but going the whole spring round is the thing.<br>I dropped far more my first year.<br><br>It isn\'t my depot any more. Congratulations.',
    'letter.1.good': 'Park\'s handwriting came with the fortnight. Says you dropped nothing.<br><br>Honestly, I thought you\'d give up inside a week.<br>I still remember the face you pulled that first morning by the container. You make it whenever you lift something heavy.<br><br>Two and a half months to go. Keep at it.',
    'letter.1.bad': 'Park\'s handwriting came with the fortnight. Says you dropped a few.<br><br>My first year I left a whole household\'s move out in the rain. That woman became a customer for twenty years.<br>It isn\'t the ones who never slip who learn the trade. It\'s the ones who don\'t run off.<br><br>Two and a half months to go. Keep at it.',
