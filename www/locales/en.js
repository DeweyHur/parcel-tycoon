...
(function (root) {
  ...
  ui: {
    ...
    'letter.2.good': "He writes that you send them full. Dispatches are bought, and unused ones simply go — top them up before they run out.<br><br>A month is enough to see. I mean to let the place go to you; the price and terms are in the deed.<br><br>Name your sign first. Hanseong is mine.",
    'letter.2.bad': "Some sat because there was no truck to call. Dispatches are bought — run out and a whole day goes empty.<br><br>Still, you saw the month through. I mean to let the place go to you; the price and terms are in the deed.<br><br>Name your sign first. Hanseong is mine.",
    ...
    'letter.1.good': "Park tells me you sent them full.<br><br>That is the whole of it — one crate or a full deck, the fee is the same.<br><br>I still cannot raise that shutter. Keep it through the spring — I'll have something to say to you before summer.",
    'letter.1.bad': "Park tells me some went out half empty.<br><br>It happens when you are pressed. But the fee is the same, so full always pays better.<br><br>I still cannot raise that shutter. Keep it through the spring.",
    'ct.modal': 'Contract',
