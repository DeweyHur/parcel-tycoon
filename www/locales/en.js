...
(function (root) {
  ...
  ui: {
    ...
    'story.l1intro.1': 'Welcome. As of today you\'re the boss here.<br>One contract, one warehouse. We start small.',
    'story.l1intro.2': 'That\'s what came in today. See the ⏳ next to it? That\'s your deadline.',
    'story.l1intro.3': 'You don\'t call a truck every day. Each one costs {fee}c.<br>Today, just <b>wait</b>.',
    ...
    'story.l1first.2': 'Fuller truck, bigger share. For now that\'s the whole job.',
    ...
    'story.l1last.1': 'Last two weeks. You\'ve got this on your own now.',
    'lv.title': 'Level {n}',
    'lv.doneTitle': 'Level {n} complete',
