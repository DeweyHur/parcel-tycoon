...
(function (root) {
  ...
  ui: {
    ...
    'mk.refillDesc': '배차를 가득 다시 계약합니다(남은 대수와 상관없이 같은 값). 배차비의 절반을 선금으로 내고, 부를 때 나머지 절반만 냅니다.',
    ...
    'story.l2refill.1': '이게 <b>재계약</b>이야. 몇 대가 남았든 <b>같은 값에 가득</b> 채워 — 그러니 다 쓰고 하는 게 이득이지.<br>배차비 절반을 선금으로 내고, 부를 때는 나머지 절반만 내.',
