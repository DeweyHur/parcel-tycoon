...
(function (root) {
  ...
  ui: {
    ...
    'rush.preview': '도크 러시 발동! 보상 ×{mult} · 추가 +{bonus}c',
    'rush.toast': '🔥 도크 러시! {n}개 일괄 출고 · 보너스 +{bonus}c',
    'rush.float': '🔥 도크 러시 +{n}c',
    'chain.title': '퍼펙트 로드',
    'chain.armed': '연쇄 준비 완료',
    'chain.mult': '{n}연쇄 · 보상 ×{mult}',
    'chain.preview': '{n}연쇄! 보상 ×{mult} · 추가 +{bonus}c',
    'chain.toast': '⚡ 퍼펙트 로드 {n}연쇄 · 보너스 +{bonus}c',
    'chain.toastMax': '⚡ MAX 연쇄! 보너스 +{bonus}c',
    'why.loadChain': '퍼펙트 로드 3연쇄',
    'chain.start': '⚡ 퍼펙트 로드! 다음 고적재 출고부터 연쇄 보너스',
    ...
    'mission.amount': '이번 미션 {now}/{target}c',
    ...
    'call.autoTrim': '꽉 차는 차까지만 담았어요. 더 보내려면 직접 고르거나, 오늘 마감할 때 직접 배송하세요.',
    'story.weatherDetail.1': '위 칸이 이번 달 날씨야. 아이콘 뜬 데까지가 확정 예보고, <b>?</b> 는 아직 몰라.<br>비는 마당에 나가 있는 것만 젖히는데, 폭염은 창고 안 🌾 농산물까지 상하게 해.',
    'story.weatherDetail.2': '그래서 예보 보고 미리 옮기는 거야. <b>오늘 마감</b> 버튼 안에 <b>적재 정리</b>가 있어 — 비싼 건 안에, 젖어도 되는 건 밖에.',
    ...
    'story.waitFirst.1': '오늘 할 일은 끝났어. <b>오늘 마감</b>을 누르면 다음 영업일로 넘어가고 새 택배를 받아.',
    'coach.wait': '오늘 출고는 끝. 현재 {vol}칸, {name} 차는 {cap}칸 — <b>오늘 마감하고 다음 입고 받기</b>.',
    ...
    'story.rushReady.2': '도크 러시가 켜지면 임시로 트럭 두 대가 더 붙어. 여러 대를 꽉 채워 한 번에 빼면 보상이 35% 폭발해. 실패하면 넘침만 남고.',
    'story.rushHit.1': '들었어? 셔터, 엔진, 입금 알림이 한꺼번에 울리는 소리. <b>이게 도크 러시야.</b>',
    ...
    'story.usage76.2': '위에 \'입고 예정\' 보이지? 앞으로 이틀에 뭐가 얼마나 오는지 미리 보여.<br>그걸 보고 오늘 마감할지 차를 부를지 정해.',
    ...
    'story.noContract.1': '저 택배, 지금 계약으로는 실을 차가 없어. 이럴 땐 오늘 마감 버튼을 눌러 봐 — 마감 전에 직접 배송으로 내가 하나씩 나를 수 있어.',
    ...
    'story.waitGo.1': '골랐으면 아래 버튼. 그거 하나 직접 나른 뒤 오늘 영업을 마감하는 거야.',
    ...
    'story.callsOut.2': '배차는 월초에 저절로 안 채워져. 월말 <b>마켓</b>에서 \'가득 충전\'을 사야 다시 차.<br>이번 달은 다른 계약으로 돌리거나, 오늘 마감할 때 직접 배송으로 버텨.',
    ...
    'intro.1': '스무 해 동안, 이 셔터는 한 사람이 올렸다.',
    'intro.2': '한 사장. 리어카 한 대로 시작한 사람.',
    'intro.3': '나는 그 밑에서 짐을 내렸다.',
    'intro.4': '지난겨울. — “이제 자네가 올려 봐.”',
    'card.han.name': '한 사장',
    'intro.skip': '건너뛰기 ▸',
    'intro.5': '“잘 굴리면 싸게 넘겨주지.”',
    'intro.6': '나한테는 여기 말고 갈 데가 없었다.',
    'intro.7': '오늘이 첫날이다.',
    'story.name.han': '한 사장님',
    'story.name.mart': '큰마트 김 대리',
    'story.l1first.3': '차를 꽉 채울수록 그 몫이 커져. 당분간은 이게 전부야.',
    'story.l1progress.1': '아래 미션 등급을 봐. 이번 달 번 돈이 쌓이면 D에서 C, B, A급으로 올라가.',
    'story.l1progress.2': '방금 80% 이상 채웠으니 퍼펙트 로드가 켜졌어. 한 번 더 꽉 채우면 연쇄 보너스가 붙는다.',
    'story.l1chainHit.1': '바로 그거야! 고적재 출고를 이어서 연쇄 배율이 붙었어.',
    'story.l1chainHit.2': '연쇄 수익은 미션 금액에도 그대로 들어가. 잘한 행동이 다음 보상을 당겨오는 구조지.',
    'story.progressHud.1': '미션 등급은 이번 달 수익 성적표야. C·B·A에 도달할 때마다 성장 자금을 바로 받아.',
    'story.progressHud.2': '80% 이상 적재를 이어 가면 퍼펙트 로드 연쇄가 커져. 대기하거나 덜 채워 보내면 끊긴다.',
    'story.chainHit.1': '연쇄 성공! 이제부터 같은 판단을 이어 갈수록 보상이 더 커져.',
    'story.chainHit.2': '연쇄 보너스로 미션 등급도 더 빨리 오른다. A급까지 밀어붙여 봐.',
    'story.l1last.2': '이 보름치는 내가 정리해서 한 사장한테 보낼게.<br>뭐라고 쓸지는… 자네가 남은 날 하는 거 보고.',
    'story.l1intro.1': '왔구만. 한 사장한테 얘기 들었어.<br>오늘부터는 짐만 내리는 게 아니야. 날 잘 따라와 봐.',
    'story.l1intro.2': '한길 물류 여 실장입니다.<br>저희 차는 <b>{nowCap}칸</b>, 한 번 부르면 <b>{nowFee}c</b>예요. 지금 있는 건 {nowVol}칸이고요.',
    'story.l1intro.3': '지금 보내면 <b>{nowLoss}c 손해</b>야. 겁나서 한 상자씩 빼는 순간 배차비에 피가 마르지.<br>하지만 너무 버티면 창고가 터져. 그 경계까지 쌓았다가 <b>한 번에 쓸어 담는 것</b> — 그게 이 일이야. 오늘은 여기서 마감해.',
    'story.l1call.1': '이제 부를 만해. 저 버튼에 <b>{readyVol}/{readyCap}칸</b>.',
    'story.l1call.2': '지금 부르면 {nowRev}c 받고 배차비 {nowFee}c — <b>{nowNet}c 남아.</b><br>첫날이랑 같은 {nowFee}c야. 눌러 봐.',
    'story.l1callPick.1': '위 게이지가 차에 얼마나 실리는지야.',
    'story.l1callPick.2': '<b>\'급한 순 자동 선택\'</b>을 눌러. 급한 것부터 차가 차는 만큼 담아 줘.',
    'story.l1callGo.1': '됐으면 호출. 호출하면 그대로 하루가 지나가.',
    'story.l1first.1': '잘했어. 수입에서 배차비를 뺀 게 자네 몫이야.',
    'story.l1first.2': '잘 받았습니다! 다음에도 꽉 채워 주시면 저희도 좋고요.',
    'story.l1free.1': '기본은 끝. 쌓이면 부르고, 오늘 할 일이 끝났으면 마감해서 다음 입고를 받아.<br>나머지는 자네가 해봐 — 옆에서 보고 있을게.',
    ...
    'story.l1sunday.1': '일요일은 쉬는 날이야. 택배도 안 오고 기한도 안 줄어.',
    'story.l1sunday.2': '푹 쉬어. 월요일에 보자고.',
    ...
    'story.l2intro.1': '첫 보름 잘 넘겼어. 도장도 찍었고, 이제 간판이 자네 거지.<br>그럼 슬슬 진짜 살림 얘기를 해야겠네.',
    'story.l2intro.2': '여기 계약 카드 밑에 <b>배차 {trucks}대</b>라고 붙었지? 서장 때는 안 보이던 거야.',
    'story.l2intro.3': '차를 한 번 부를 때마다 저게 하나씩 준다.<br>한 사장이 미리 끊어 둔 게 딱 저만큼이거든.',
    'story.l2rushReady.1': '창고에 불 붙었다. 지금 도크 러시가 준비됐어 — 평소보다 트럭 두 대를 더 붙일 수 있다.',
    'story.l2rushReady.2': '여기서 여러 대를 꽉 채워 한꺼번에 비우면 35% 추가 보상. 못 비우면 다음 입고가 마당을 덮쳐. 선택해.',
    'story.l2rushHit.1': '그래, 바로 그거야! 창고 하나를 통째로 현금으로 바꿨어.',
    'story.l2rushHit.2': '다음엔 홍보로 더 끌어오고, 창고를 더 버티게 만들고, 트럭을 더 붙여. 작은 출고가 아니라 <b>폭발을 키우는 거야.</b>',
    'story.l2calls.1': '봐, 하나 줄었지. 저게 다 떨어지면 물건이 있어도 차를 못 불러.',
    'story.l2callsOut.1': '배차가 0이야. 보낼 건 저기 쌓여 있는데 차가 안 와.',
    'story.l2callsOut.2': '이게 월초에 저절로 안 채워져. <b>사야 해.</b><br>이번 달 정산 끝나면 보여 줄 데가 있어.',
    'story.l2market.1': '여기가 마켓이야. 창고 살림을 늘리는 건 전부 여기서 산다.',
    'story.l2market.2': '배차 충전, 계약 한도, 창고 확장 — 살 수 있는 건 보름마다 좀 달라져.<br>한 번에 살 수 있는 개수도 정해져 있고.',
    'story.l2refill.1': '이게 충전이야. 값이 정액이라 <b>남은 배차가 있을 때 채우면 그만큼 버리는 것</b>이고.',
    'story.l2refill.2': '지금은 0이니까 채워도 안 아까워. 눌러 봐.',
    'story.l2limit.1': '이건 한도를 올리는 거야. 충전은 그릇을 채우는 거고, 이건 <b>그릇을 키우는 것</b>이지.<br>한 번 사면 계속 남아.',
    'story.l2two.1': '오, 두 대 붙었네. 한 대로 안 실리니까 자동으로 붙은 거야.',
    'story.l2two.2': '대신 배차도 둘, 배차비도 둘이야. 급하지 않으면 한 대씩 꽉 채워 보내는 게 싸.',
    ...
    'story.l3rain.2': '오늘 마감 버튼 눌러 봐. 마감 전에 안팎을 바꿀 수 있어.',
    'story.l3reorder.1': '여기 <b>적재 정리</b>. 안에 넣을 것과 밖에 둘 것을 자네가 골라.<br>급하지 않고 값싼 걸 밖에 두는 게 낫지.',
    'story.l3theft.1': '없어졌어. 마당은 문이 없잖아.',
    'story.l3theft.2': '밖에 오래 두면 가끔 이래. 마당 울타리를 치면 좀 낫고.',
    'story.l3self.1': '차가 없네. 이럴 땐 <b>직접 배송</b>이 있어 — 오늘 영업을 마감하기 전에 내가 하나씩 나르는 거야.',
    'story.l3self.2': '배송비가 좀 나가는데 반송보다는 싸. 오늘 마감 버튼 눌러 봐.',
    'story.l3selfPick.1': '여기서 오늘 들고 갈 걸 골라. 작은 것만 돼, 두 칸까지.',
    'story.l3trust.1': '이제 이거 보여 줄 때가 됐네. <b>신뢰도</b>야.',
    'story.l3trust.2': '자네가 한길이랑 반년 가까이 거래했잖아. 그동안 쌓인 거야.<br>차 두 대가 붙은 것도, 배차비가 싸진 것도 다 이것 때문이었어.',
    ...
    // ----- 3장 (9~10월): 찬 것 · 깨지는 것 · 이름이 있는 화주 -----
    'story.l4intro.1': '사월 후반이면 이사철이 한창이야. 오는 물건이 달라져.<br>지금까지는 그냥 상자였잖아. 이제 <b>상하는 것</b>도 오고 <b>깨지는 것</b>도 와.',
    'story.l4intro.2': '그리고 하나 더 — 이제 누가 보냈는지가 적혀 나와.',
    'story.l4cust.1': '보이지? 택배 옆에 붙은 저 표시가 <b>화주</b>야.<br>여태 개인 손님만 받았는데, 이제 이름 있는 데서도 맡겨.',
    'story.l4cust.2': '같은 데 물건을 제 날짜에 계속 보내면 그쪽 신뢰가 쌓여.<br>신뢰가 쌓이면 물량도 늘고 단가도 올라. 아래 <b>고객</b> 버튼에서 볼 수 있어.',
    'story.l4warn.1': '이거 봐. 다음 보름에 <b>❄ 신선</b>이 오는데 우리가 받을 데가 없어.',
    'story.l4warn.2': '찬 건 둘 데하고 보낼 데가 둘 다 있어야 해. 오고 나서 사면 늦어.',
    'story.l4coldCar.1': '냉장 계열 계약이야. <b>보내는</b> 쪽이 이걸로 풀려.<br>우리 한길은 찬 걸 안 받거든 — 계열마다 받는 게 정해져 있어.',
    'story.l4coldFac.1': '이건 <b>두는</b> 쪽. 창고 안에 냉장 구역을 내는 거야.',
    'story.l4coldFac.2': '❄ 는 밖에 나가면 하루 만에 상해. 냉장 구역이 꽉 차면 그냥 창고로 밀리고, 거기서도 오래 못 버텨.',
    ...
    'story.l4fragile.1': '⚠ 붙은 거, 저건 깨지는 물건이야.',
    'story.l4fragile.2': '아무 차나 실리긴 하는데 <b>깨질 확률</b>이 붙어. 깨지면 물어줘야 하고.<br>파손 계열 계약이나 완충 특약이 있으면 그 확률이 없어져.',
    ...
    'story.l5full.2': '이럴 땐 계약 말고 <b>특약</b>이야. 지금 있는 계약에 조건을 하나 더 붙이는 거지 —<br>자리를 안 먹어. 대신 계약 하나에 특약은 하나만.',
    ...
    'story.l1last.1': '벌써 마지막 보름이네. 이제 자네가 나보다 빨라.',
    'letter.title': '한 사장 편지',
    'letter.toName': '{name} 사장 보게',
    'letter.toYou': '자네 보게',
    'letter.sign': '한 사장',
    'letter.close': '접어 넣는다',
    'letter.generic.good': '박 반장 글씨로 보름치가 왔더군. 숫자보다 그 사람 말투가 좋았네.<br><br>나는 이 창고를 마흔에 샀어. 그때는 리어카 한 대였지.<br>자네가 지금 서 있는 자리가 내가 마흔에 섰던 자리야. 별거 없지? 원래 별거 없어.<br><br>다음 보름도 부탁하네.',
    'letter.generic.bad': '박 반장 글씨로 보름치가 왔더군. 몇 개 흘렸다고.<br><br>괜찮네. 나도 첫해에 남의 이삿짐을 통째로 비 맞혔어.<br>그 집 아주머니가 이십 년 단골이 됐지. 사과를 제대로 하면 그렇게 되더군.<br><br>다음 보름도 부탁하네.',
    'letter.2.good': '박 반장 글씨로 보름치가 또 왔네. 차를 꽉 채워 보낸다고 적혀 있었어.<br><br>배차라는 게 원래 그래. 돈으로 사는 건데 안 쓰면 그냥 사라지지.<br>나도 그거 아는 데 삼 년 걸렸네. 자네는 보름 만에 알았고.<br><br>간판은 달았나? 아직이면 서둘지 말고.',
    'letter.2.bad': '보름치 잘 받았네. 차가 없어서 못 보낸 게 좀 있었다고.<br><br>그건 자네 잘못이 아니라 셈을 아직 못 해 본 거야. 한 번 겪으면 다시는 안 그래.<br><br>남은 두 달, 계속 해 보게.',
    'letter.3.good': '봄비를 넘겼구먼. 마당에 물건 내놓고 비 맞힌 적 없다고 적혀 있네.<br><br>나는 첫해 봄비에 이삿짐 한 채를 통째로 적셨어. 그 집 아주머니가 나중에 이십 년 단골이 됐지만,<br>그건 운이 좋았던 거고 자네처럼 하는 게 맞아.<br><br>이사철 되면 물건이 달라져. 박 반장 말 잘 듣고.',
    'letter.3.bad': '보름치 받았네. 비에 좀 젖었다고 적혀 있었어.<br><br>지붕 없는 데 물건을 두면 그렇게 되는 거지. 마당은 어디까지나 임시야.<br>창고를 넓히든, 더 자주 보내든 — 방법은 자네가 고르게.<br><br>남은 한 달 반, 부탁하네.',
    'letter.4.good': '이사철 보름치가 왔네. 찬 물건 하나도 안 상하고 넘겼다고.<br><br>냉장은 돈이 든다고 미루는 사람이 많은데, 한 번 상하면 그게 더 비싸.<br>자네는 그 계산을 이미 한 거고.<br><br>화주들 이름도 여럿 적혀 있더군. 사람이 붙기 시작했다는 뜻이야.',
    'letter.4.bad': '보름치 받았네. 몇 개 상했다고 적혀 있었어.<br><br>찬 건 기다려 주질 않아. 나도 그거 배우느라 봄 하나를 통째로 썼네.<br><br>남은 한 달. 이제 진짜 바쁜 철이야.',
    'letter.5.good': '오월 전반치가 왔네. 그 물량을 하나도 안 흘렸다고.<br><br>솔직히 놀랐어. 가정의 달은 나도 매년 몇 개씩 놓쳤거든.<br>이 동네에서 자네 이름을 안다는 게 이제 빈말이 아니야.<br><br>보름만 더 넘기면 끝이야. 마지막까지 부탁하네.',
    'letter.5.bad': '오월 전반치 받았네. 몇 개 흘렸다고.<br><br>그 보름은 원래 그래. 나도 스무 해 하면서 한 번도 깨끗하게 넘긴 적이 없어.<br>중요한 건 자네가 아직 여기 있다는 거지.<br><br>마지막 보름 하나 남았네.',
    'letter.6.good': '마지막까지 넘겼구먼.<br><br>봄 한철을 다 돌았어. 삼월에 처음 왔을 때 자네 표정이 아직 기억나는데,<br>그때는 리어카도 못 끌 것 같더니.<br><br>이제 거기는 내 창고가 아니야. 축하하네.',
    'letter.6.bad': '마지막까지 넘겼구먼.<br><br>몇 개 흘렸다고 적혀 있었지만, 봄 한철을 다 돌았다는 게 중요한 거야.<br>나도 첫해엔 훨씬 더 흘렸네.<br><br>이제 거기는 내 창고가 아니야. 축하하네.',
    'letter.1.good': '박 반장 글씨로 보름치가 왔더군. 하나도 안 흘렸다고 적혀 있었네.<br><br>솔직히 말하면 나는 자네가 일주일쯤 하다 그만둘 줄 알았네.<br>첫날 컨테이너 앞에서 짓던 그 표정을 아직 기억하거든. 무거운 거 들면 꼭 그 표정이야.<br><br>남은 두 달 반, 계속 해 보게.',
    'letter.1.bad': '박 반장 글씨로 보름치가 왔더군. 몇 개 흘렸다고.<br><br>나도 첫해엔 남의 이삿짐을 통째로 비 맞혔네. 그 집 아주머니가 나중에 이십 년 단골이 됐지.<br>일은 안 틀리는 사람이 아니라 안 도망가는 사람이 배우는 거야.<br><br>남은 두 달 반, 계속 해 보게.',
    'lv.nextCh': '{ch}이 곧 열립니다.',
    'ct.modal': '계약',
    ...
    'ct.buyer': '매수인',
    'ct.item': '목적물',
    'ct.itemName': '동네 창고 1동 · 부속 마당',
    'ct.body': '위 목적물의 값을 {price}c 로 한다. 오늘 계약금 {down}c 를 받았다.<br>잔금 {rest}c 는 보름마다 한 회차씩, 남은 두 달 반 안에 나눠 낸다. 이자는 붙이지 않는다.<br>매수인은 들어온 물건을 제 날짜에 내보낼 것. 그것 말고는 조건이 없다.',
    'inst.modal': '잔금',
    ...
    'inst.cleared': '값을 다 치렀다. 이제 이 창고는 내 것이다.',
    'inst.btn': '부친다',
    'inst.btnFinal': '계약서를 받는다',
    'ct.titleFinal': '창 고 매 매 계 약 서',
    'ct.bodyFinal': '위 목적물의 값을 전액 수령하였다. 매도인은 목적물을 매수인에게 완전히 넘긴다.<br>봄 한철 하나도 안 흘렸다. 그거면 됐다.',
    ...
    'lv.sub.6': '마지막 봄',
    'ch.when': '{y}년 {a}월 — {b}월',
    'ch.whenHalf': '{y}년 {cal}월 {half}',
    'ch.tap': '화면을 누르면 시작합니다',
    'ch.tapNext': '화면을 누르면 이어집니다',
    'ch.endTitle': '{ch} · 끝',
    'ch.nextLabel': '다음',
    'ch.soon': '준비 중',
    'ch.end.1': '셔터는 이제 내 손으로 올린다.',
    'ch.end.2': '마당에 차가 한 대 더 늘었다.',
    'ch.end.3': '봄비가 그치고, 마당이 말랐다.',
    'ch.end.4': '찬 것들이 제 자리를 찾았다.',
    'ch.end.5': '이름이 동네를 넘었다.',
    'ch.end.6': '봄이 다 갔다. 셔터는 이제 완전히 내 것이다.',
    'lv.ch.1': '서장',
    'lv.ch.2': '1장',
    'lv.ch.3': '2장',
    'lv.ch.4': '3장',
    ...
    'lv.nameBody': '보름 굴려 봤으니 이제 간판을 달아야지. 값은 값대로 쳐 줄 테니까.<br>계약서에 뭐라고 적을까?',
    'lv.namePlaceholder': '상호 이름',
    'lv.nameSave': '이걸로 하자',
    'lv.nameDefault': '한길 택배',
    ...
    'lv.doneGo': '다음',
    'sum.toNext': '{n} 시작',
    'help.l1': '<b>이 일의 전부</b><br>택배가 영업일마다 들어옵니다. 쌓아 뒀다가 <b>차를 꽉 채워</b> 보낼수록 택배 한 개당 비용이 싸집니다.<br><br><b>기한</b> 택배마다 ⏳ 가 붙어 있습니다. 넘기면 보상이 깎이고, 이틀을 더 넘기면 반송됩니다.<br><b>오늘 마감</b> 오늘 할 일을 끝내고 다음 영업일의 택배를 받습니다.<br><b>창고</b> 다 차면 남는 것은 마당에 쌓입니다.<br><b>일요일</b> 쉬는 날입니다. 입고도 기한도 멈춥니다.<br><b>정산</b> 보름마다 수입에서 배차비와 임대료를 뺍니다.<br><br><span style=\'color:var(--dim)\'>나머지는 박 반장이 그때그때 알려 줍니다.</span>',
    'title.story': '인수인계',
    ...
    'wm.selfHead2': '크기 ≤ {size} · 보상 그대로, 배송비 {base}c + 크기×{per}c',
    'wm.vans': '차량',
    'wm.noVans': '차량 없음 — 속성 없는 택배·농산물만',
    'wm.blocked': '직접 배송 불가 {n}개 (택배 상세에서 사유 확인)',
    'wm.title': '오늘 마감',
    'wm.selfWait': '직접 배송 {n}개 후 오늘 마감 (-{cost}c)',
    'wm.justWait': '오늘 마감 · 다음 입고 받기',
  ...
  // 내부 규칙명은 wait를 유지하지만, 플레이어에게는 능동적인 '오늘 마감' 행동으로 안내한다.
  for (const [from, to] of [
    ['운송 업체를 호출해 처리하거나 <b>대기</b>해서 택배를 모아 두세요.', '운송 업체를 호출해 처리하거나 <b>오늘 영업을 마감</b>하고 다음 입고를 받아 택배를 모으세요.'],
    ['입고 → 업체 호출 또는 대기 → 배송', '입고 → 업체 호출 또는 오늘 마감 → 배송'],
    ['<h3>대기 · 직접 배송 · 차량</h3><p><b>대기</b>를 누르면 영업일 넘기기 화면이 열립니다.', '<h3>오늘 마감 · 직접 배송 · 차량</h3><p><b>오늘 마감</b>을 누르면 다음 입고 확인 화면이 열립니다.'],
    ['창고가 넘칠 때 <b>대기</b>를 누르면', '창고가 넘칠 때 <b>오늘 마감</b>을 누르면'],
    ['차를 부른 날에는 열리지 않습니다 — 대기의 보상입니다.', '차를 부른 날에는 열리지 않습니다 — 호출 없이 하루를 마감할 때의 보상입니다.'],
    ['<b>직접 배송</b>: 대기할 때', '<b>직접 배송</b>: 오늘 마감할 때'],
