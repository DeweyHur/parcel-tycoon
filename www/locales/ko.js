...
(function (root) {
  ...
  ui: {
    ...
    'hud.spare': '예비',
    'hud.contractSub': "<b>{cap}</b>칸·{fee}c · 대상 <b>{vol}</b>칸",
    'hud.noTurn': '턴 미소모',
    'hud.regular': '정기',
    'hud.express': '고속',
    'wait.overdue': '⏳초과 {n}',
    ...
    'story.intro.1': '어서 와. 오늘부터 여기 사장은 자네야.<br>나는 석 달만 옆에서 잔소리하고 빠질게. 듣기 싫으면 저 ×를 눌러.',
    ...
    'story.callModal.1': '버튼에 <b>{openCap}칸·{openFee}c · 대상 {openVol}칸</b> 이렇게 적혀 있었지?<br>차 한 대가 {openCap}칸, 한 대 부를 때마다 {openFee}c, 지금 이 계약으로 실을 수 있는 게 {openVol}칸이란 뜻이야. 위 게이지가 그걸 그림으로 보여주는 거고.',
