...
(function (root) {
  ...
  ui: {
    ...
    'rush.title': "일괄 출고",
    'camp.title': "홍보 캠페인",
    'camp.desc': "창고가 비면 직접 물량을 끌어온다. 보름에 한 번 열 수 있다.",
    'camp.btn': "캠페인 열기",
    ...
    'story.l3invest.1': "저 아래 <b>투자</b> 버튼, 이제부터 쓸 수 있어. 번 돈을 창고·차·홍보에 도로 넣는 데야.",
    'story.l3invest.2': "특히 홍보는 <b>캠페인</b>이야. 열면 며칠 안에 물량이 몰려와.<br>창고가 비어 도는 게 제일 아까운 거거든 — 비면 자네가 직접 끌어와.",
