...
(function (root) {
  ...
  ui: {
    ...
    'story.intro.3': '{name}은/는 차 한 대에 무조건 {fee}c야. 한 개를 싣든 터질 만큼 싣든 똑같아.<br>겁먹고 조금씩 빼면 말라 죽고, 버티다 넘치면 한 방에 망해. <b>쌓고, 계산하고, 한 번에 터뜨려.</b> 오늘은 기다려.',
    ...
    'story.l1intro.3': '지금 보내면 <b>{nowLoss}c 손해</b>야. 겁나서 한 상자씩 빼는 순간 배차비에 피가 마르지.<br>하지만 너무 버티면 창고가 터져. 그 경계까지 쌓았다가 <b>한 번에 쓸어 담는 것</b> — 그게 이 일이야. 오늘은 기다려.',
