...
(function (root) {
  ...
  ui: {
    ...
    'btn.close': '닫기',
    'common.none': '없음',
    'season.note.1': "비수기 — 물량 −15%, 냉동 소폭 ↑",
    'season.note.2': "선물 시즌 — 물량 −10%, 파손주의 ↑",
    'season.note.3': "새 학기·이사철 — 기본",
    'season.note.4': "봄나물 — 농산물 ↑",
    'season.note.5': "가정의 달 — 물량 +5%, 파손주의(선물) ↑",
    'season.note.6': "초여름 — 신선 ↑",
    'season.note.7': "폭염 — 신선·냉동 ↑, 물량 −5%",
    'season.note.8': "폭염·휴가 — 신선·냉동 ↑, 물량 −5%",
    'season.note.9': "추수·명절 — 농산물 ↑, 물량 +5%",
    'season.note.10': "수확·직구 — 농산물·통관 ↑, 물량 +10%",
    'season.note.11': "블랙프라이데이 — 물량 +30%, 통관·파손 ↑",
    'season.note.12': "연말 성수기 — 물량 +40%, 파손·냉동·대형 ↑",
  ...
  meta:   {
    ...
    "SCENARIOS": {
      "standard": {
        "name": "한 해 (12개월)",
        "desc": "기본 런. 3월 봄에 시작해 폭염·추수·블랙프라이데이·연말 성수기를 지나 이듬해 2월까지. 고객 신뢰가 오르며 물량이 배로 늘고, 지출도 따라 큰다",
        "win": "12개월 생존 (점수 ×1.5)",
        "recommend": "동네 택배"
      },
      "half": {
        "name": "튜토리얼 (반기)",
        "desc": "3월~8월 6개월. 계약·배차·마켓·신뢰를 익히는 짧은 런. 여름 폭염까지 겪는다",
        "win": "6개월 생존 (점수 ×0.8)",
        "recommend": "동네 택배"
      },
      "peak": {
        "name": "성수기",
        "desc": "입고 ×1.5, 폭주 턴 5회(폭주 입고분 기한 -2), 반송 유예 2턴. 보상 +10, 가격 ×1.3, 시작 호출 +2",
        "win": "2개월 생존 + 50개 처리",
        "recommend": "도심 퀵 · 강철 창고"
      },
      "heatwave": {
        "name": "폭염",
        "desc": "신선 비율 +20%p, 상온 부패 3배, 폭염 경보 턴(월 3회)",
        "win": "3개월 생존 + 폐기 3개 이하",
        "recommend": "프레시 로지스틱스"
      },
      "strike": {
