...
(function (root) {
  ...
  ui: {
    ...
    'story.l1intro.2': '한길 물류 여 실장입니다. 한 번 부르면 <b>{nowFee}c</b>예요.<br>저기 보이시죠 — 뒤가 차 한 대에 들어가는 칸, 앞이 지금 실릴 양이에요.',
    'story.l1intro.3': '지금 부르면 <b>{nowLoss}c 손해</b>야. 한 칸을 싣든 다 싣든 배차비는 똑같거든.<br>쌓아 뒀다 꽉 채워 보내는 게 이 일이야. 오늘은 <b>기다려</b>.',
    ...
    'letter.2.good': '차를 꽉 채워 보냈다고 적혀 있네.<br><br>배차는 사 두는 거라 안 쓰면 그냥 사라지네. 바닥나기 전에 채워 두게.',
    'letter.2.bad': '차가 없어서 못 보낸 게 있었다고.<br><br>배차는 사 두는 거네. 떨어지면 하루가 통째로 비니, 미리 채워 두게.',
    ...
    'letter.6.good': '다 넘겼구먼.<br><br>이제 거기는 내 창고가 아니네. 축하하네.',
    'letter.6.bad': '몇 개 흘렸다지만, 끝까지 간 게 중요하네.<br><br>이제 거기는 내 창고가 아니네. 축하하네.',
    'letter.1.good': '박 반장한테 들었네. 차를 꽉 채워 보냈다고.<br><br>그거 하나면 되네. 한 칸을 싣든 다 싣든 배차비는 같으니까.',
    'letter.1.bad': '박 반장한테 들었네. 덜 채워 보낸 게 있었다고.<br><br>급하면 그럴 수 있지. 그래도 배차비는 같으니, 채워 보내는 쪽이 늘 남네.',
