...
(function (root) {
  ...
  ui: {
    ...
    'media.radio': "지역 라디오",
    'media.bus': "버스·옥외 광고",
    'media.upName': "{name} 강화 Lv.{lv}",
    'media.upLine': "보름에 {n}번 → {n2}번",
    'media.newHead': "광고",
    'media.ticket': '{name} 캠페인권',
    'media.ticketOnce': '1회용 · 집행비 포함',
    'media.ticketLeft': '{n}장',
    'camp.noTicket': '캠페인권이 없습니다 — 정산 마켓에서 1회용 캠페인권을 사세요',
    'media.run': "집행",
    'growth.fleet': "차량",
    'growth.warehouse': "창고",
    'growth.automation': "자동화",
    'growth.branding': "브랜드",
    'growth.coldchain': "저온 물류",
    'growth.desc.fleet': "모든 계약 배차 +1대",
    'growth.desc.warehouse': "창고 +{n}칸",
    'growth.desc.automation': "배차비 -4% · 인건비 -8%",
    'growth.desc.branding': "화물값 +3% · 특급 확률 +4%",
    'growth.desc.coldchain': "냉장 +2 · 냉동 +1",
    'growth.head': "성장 투자",
    'camp.half': '겹침 {n}',
    ...
    'hv.flow.wait': '호출 없음',
    'hv.flow.tick': '기한 −1',
    'hv.day.week': '월~토 영업, 일요일 휴무',
    'hv.day.cycle': '보름마다 정산 → 마켓',
    'hv.call.tap': '계약 카드를 누르면 급한 것부터 <b>차가 차는 만큼</b> 담깁니다',
    'hv.call.box': '상자를 누르면 빼고 넣기',
    'hv.call.btn': '아래 큰 버튼이 <b>호출</b>로 바뀝니다 · 카드를 다시 누르면 취소',
    'hv.call.half': '배차비는 대당 고정 — <b>{pct}% 넘게</b> 채우면 남는 장사',
    'hv.call.two': '넘치면 차가 저절로 붙습니다 — 한 번에 <b>{n}대</b>까지',
    'hv.call.pips': '파란 막대 = 남은 배차 — 쓰면 줄고, 마켓에서 재계약으로 채운다',
    'hv.kind.size': '크기',
    'hv.kind.normal': '아무 차나',
    'hv.kind.fresh': '냉장 밖에 두면 다음 날 폐기',
    'hv.kind.frozen': '냉동실 밖이면 즉시 폐기',
    'hv.kind.fragile': '파손 안전이 아닌 차는 25% 깨짐',
    'hv.kind.produce': '폭염엔 기한 −2',
    'hv.kind.intl': '도착 후 통관 2일',
    'hv.kind.large': '크기가 맞는 차만',
    'hv.early.fast': '들어오자마자',
    'hv.early.ok': '여유 있게',
    'hv.early.due': '기한 맞춰',
    'hv.early.late': '늦게',
    'hv.trust.lv': '업체 신뢰 — 차 한 대에 실은 택배 점수 평균 (−2~+2) · Lv {a} / {b} / {c}xp',
    'hv.rep.rule': '평판 — 같은 합 ÷{div} (±{max}) · 사고 없는 정산 +{clean} · 폐기·도난 −',
    'hv.due.late': '기한을 넘기면 보상 −{pct}% · {n}일 더 두면 반송',
    'hv.wh.main': '창고',
    'hv.wh.cold': '냉장',
    'hv.wh.frozen': '냉동',
    'hv.wh.yard': '야외',
    'hv.wh.over': '넘친 짐은 야외로 — 도난 {th}',
    'hv.wh.coldRule': '❄ 🧊 는 냉장·냉동 구역에',
    'hv.wh.wait': '호출 없이 넘기면 야외 짐 정리',
    'hv.wx.fc': '예보는 이틀 앞까지 — 위 내일·모레 칩',
    'hv.camp.lv': '캠페인권은 마켓에서 사는 1회용 — 쓰면 없어진다. 캠페인 물량·캠페인 중 반송은 평판 벌점이 더 크다',
    'hv.camp.half': '돌고 있는 캠페인과 겹치면 효과 반감',
    'hv.camp.same': '같은 매체는 끝날 때까지 다시 못 함',
    'hv.pay.fee': '배차비는 정산 때 한꺼번에',
    'hv.pay.op': '운영비 월 {n}c + 계약·시설 유지비',
    'hv.pay.note': '어음은 만기 정산에 현금으로',
    'hv.pay.loan': '잔고가 모자라면 단기 대출 (이자 {pct}%, 한도 {limit}c)',
    'hv.pay.market': '정산 뒤 마켓 — 계약·강화·시설',
    'hv.run.q': '봄',
    'hv.run.q2': '여름·가을·겨울',
    'hv.run.half': '반기',
    'hv.run.year': '한 해',
    'hv.run.holiday': '설·추석 전 5일은 입고 ×1.6, 연휴엔 호출 불가',
    'camp.runs': "횟수",
    ...
    'camp.title': '캠페인',
    'camp.button': '📣캠페인',
    'camp.desc': "창고가 빌 때 물량을 끌어온다. 캠페인권은 한 번 쓰면 끝 — 정산 마켓에서 산다.",
    'camp.btn': "캠페인 열기",
    'camp.effect': "{days}영업일 안에 {n}건이 더 들어온다",
    'camp.used': "이번 보름 횟수를 다 썼다",
    ...
    'jackpot.sweep': '창고 싹쓸이! {n}개 전부 출고',
    'jackpot.rush': '⚡ 긴급 전부 당일 출고!',
    'ps.rushToday': '⚡×{x}',
    ...
    'grade.merit': "프리미엄 계약은 차량이 크고 배차가 많은 대신 배차비가 비쌉니다",
    ...
    'mk.feeEach': "대당 {n}c",
    'mk.upgrade': "업그레이드",
    'mk.emptySlots': "빈 슬롯 {n}",
    'mk.fcNow': "이번 보름",
    'mk.fcNext': "다음 보름",
    'mk.insChange': "바꾸기",
    'mk.enhNoTarget': '붙일 수 있는 계약이 없음 (강화 칸이 찼거나 이 업체는 못 받음)',
    'slot.replaceHint': '칸이 다 참 — 눌러서 하나를 교체',
    'slot.pickSwap': '{name} 을(를) 끼우려면 하나를 빼야 합니다. 뺄 강화를 고르세요 (환불 없음)',
    'log.enhReplace': '{contract}: {old} → {name} 교체',
    'mk.lossLine': '바꾸면 못 싣게 됨: {types} · 창고의 {n}개',
    'mk.lossTitle': '처리 못 하는 물품이 생깁니다',
    'mk.lossBody': '이 계약으로 바꾸면 아래 택배를 안전하게 실을 차가 없어집니다. 그대로 두면 기한을 넘겨 반송될 수 있어요.',
    'mk.lossGo': '그래도 교체',
    'slot.block.full': '강화 칸이 다 찼음',
    'slot.block.plain': '일반 전용 업체 — 속성 특약 불가',
    'slot.block.has': '이미 이 속성을 처리함',
    'slot.block.size': '차가 커서 안 됨 (크기 최대 4 이하 계약만)',
    'slot.block.none': '적용 불가',
    'mk.newContracts': "새 계약",
    'mk.noEmptySlot': "자리 없음 — 사면 기존 계약과 바꿉니다",
    'sum.notesPaid': "어음 만기 입금",
    'sum.notesCount': "{n}장",
    'sum.notesLeft': "미만기 어음",
    ...
    'log.paid': "📄 {name} 어음 만기 +{amount}c ({count}개)",
    'log.heatAlert': ' 🌡폭염 경보!',
    ...
    'log.callDelay': ' (📄 {delay:보름 어음|한 달 어음})',
    ...
    'market.dealRenew': '{name} 재계약',
    'mk.sign': '서명',
    'mk.signed': '서명함',
    'deal.cycles': '{n}사이클',
    'deal.cells': '~{n}칸/사이클 ±{sp}%',
    'deal.rel': '관계 Lv{n}',
    'deal.fan': '{name} 제휴 — 물량·단가↑',
    'deal.fanList': '제휴 보험: {list}',
    'deal.line': '📄 {left}/{cycles}사이클 · 이번 {got}/{target}칸 · 정시 {pct}% · ⚡{rush} · 사고 {claims}',
    'deal.none': '계약 없음 — 정산 마켓의 제안서로',
    'deal.head': '기업 계약',
    'deal.anonHead': '개인 고객 — 평판이 오르면 늘어나는 바탕 물량',
    'deal.rules': '📄 기업은 정산 마켓의 제안서로 · 🛡 보험 필수(제휴면 조건↑) · 만기 평가 S/A/B/C → 관계·평판 · 🎁 무사고 완료 보너스',
    'deal.result': '{icon} {name} 만기 — 평가 {grade} ({score}점){bonus}{rel}',
    'deal.resultBonus': ' · 🎁 +{n}c',
    'deal.resultRel': ' · 관계 Lv{n}',
    'err.deal.insurance': '🛡 보험에 들어야 서명할 수 있습니다',
    'err.deal.slots': '기업 계약은 동시에 {n}개까지',
    'err.deal.dup': '이미 계약 중입니다',
    'log.dealSign': '기업 계약: {name} {cycles}사이클 · 사이클당 ~{cells}칸',
    'log.dealDone': '{name} 계약 만기 — 평가 {grade}{bonus}',
    'log.dealBonus': ' · 무사고 보너스 +{n}c',
    'why.repDeal': '{name} 계약 평가 {grade}',
    'deal.relLbl': '관계',
    'sum.secDeal': '기업 계약 만기',
    'hv.deal': '고객 · 기업 계약',
    'hv.deal.anon': '개인 고객 물량은 바탕 — 평판이 오를수록 늘어난다',
    'hv.deal.offer': '기업은 정산 마켓의 <b>제안서</b>로 온다: {a}~{b}사이클 동안 예상 물량(±{sp}%)을 보낸다. 서명은 공짜',
    'hv.deal.ins': '<b>보험 필수</b>. 그 기업의 제휴 보험사에 들어 있으면 물량·단가가 오른다',
    'hv.deal.grade': '만기에 평가 S/A/B/C — 정시율, ⚡긴급 당일 처리 가산, 사고 감산. S·A 는 관계·평판↑, C 는 관계·평판↓ + 한동안 제안 없음',
    'hv.deal.bonus': '사고 없이 끝내면 <b>완료 보너스</b>',
    'hv.deal.rel': '관계가 높을수록 개당 보너스·다음 제안서의 물량·단가가 커진다. 평판 등급이 오르면 새 기업이 찾아온다',
    ...
    'how.3.d': '한국 달력에서 고른 만큼 — 봄 석 달부터 시작해 분기(3개월) · 반기(6개월) · 한 해로 넓어집니다. 명절은 그 해의 실제 날짜에 옵니다. 돈이 마르거나 평판이 바닥나면 끝입니다.',
    ...
    'opt.off': '꺼짐',
    'cal.kr.name': '한국',
    'prep.scenarioTitle': "런 선택",
    'prep.stepOf': '{n}/{m} 단계',
    'prep.slotEmpty': '빈 칸',
    'prep.insuranceShort': '보험 (월말 차감)',
    'prep.step1': '1/3 단계',
    'btn.title': '타이틀',
    'prep.runWhenSame': '{y1}',
    'prep.runWhenNext': '{y1}→{y2}',
    'prep.span.quarter': "분기 — 석 달",
    'prep.span.half': "반기 — 여섯 달",
    'prep.span.year': "한 해",
    ...
    'prep.step3': '3/3 단계',
    'prep.perkCount': '퍽 {n}/{slots} · 계열당 1',
    ...
    'cust.upHint': '신뢰가 오르면 물량·보상 ↑',
    'cust.locked': '아직 오지 않은 고객',
    ...
    'why.repEarly': '기한보다 일찍 보냄',
    'why.repLate': '기한 넘겨 보냄',
    'why.rush': "일괄 출고 성공",
    ...
    'rep.greet.fragile': '{center} 안 대리입니다. {vehicle} {cap}칸, 대당 {fee}c, 배차 {trucks}대예요. ⚠ 는 저희 차에선 안 깨져요 — 일반이랑 농산물도 같이 실어 드리지만, 남는 건 ⚠ 를 실을 때예요.',
    'rep.greet.fragile.1': '{center} 안 대리입니다! 차는 {cap}칸 그대로인데 배차가 {trucks}대로 넉넉해요, 대당 {fee}c. ⚠ 는 한 번에 몰아서 주세요 — 뽁뽁이는 제가 챙겨 다닙니다.',
    'rep.greet.fragile.2': '{center} 안 대리입니다. 이번 차는 커서 ⚠ 대형까지 실어요 — 크기 7까지. {cap}칸, 대당 {fee}c, 배차 {trucks}대. 큰 유리일수록 저희한테요.',
    'rep.greet.fragile.3': '{center}, 안 대리입니다. 여기 차는 냉장 칸도 있어서 깨지는 신선까지 받아요. {cap}칸, 대당 {fee}c, 배차 {trucks}대. 제일 까다로운 짐은 다 저한테 주세요.',
    ...
    'rep.greet.rail': '{center} 노 기사요. 트레일러 한 대에 {cap}칸 실어 화물역까지 가. 돈은 역에서 넘기고 다음 영업일에 들어와. {trucks}대, 대당 {fee}c.',
    'rep.greet.rail.1': '{center} 노 기사요. 고속 화물편이라 돈이 바로 들어와. {cap}칸, 대당 {fee}c, {trucks}대.',
    ...
    'story.usage.1': '창고 간판에 <b>창고 12/24</b> 식으로 찬 칸이 적혀 있어. 반까지는 편하고, 4분의 3 넘으면 슬슬 신경 쓰고, 다 차면 밖에 쌓이기 시작해.<br>밖은… 나중에 얘기하자.',
    ...
    'story.callModal.3': '카드를 누르면 급한 것부터 <b>차가 꽉 차는 만큼만</b> 담아 둬. 상자를 누르면 빼고 넣고.<br>반쯤 빈 차를 하나 더 부르면 배차비만 더 나가거든. 그래도 보내야 하면 직접 골라서 넣으면 돼.',
    ...
    'story.callGo.2': '됐으면 아래 <b>호출</b> 버튼. 호출하면 그대로 하루가 지나가. 카드를 다시 누르면 차를 물리고 그냥 쉴 수도 있어.',
    ...
    'story.l1call.1': '이제 부를 만해. 벌써 <b>{readyVol}/{readyCap}칸</b>어치야.<br>아래 <b>한길</b> 카드를 눌러 봐 — 그래야 차가 서.',
    'story.l1callGo.1': "한길 물류 여 실장입니다. 저희 차, 한 번 부르면 <b>{nowFee}c</b>예요.<br>색칠된 칸이 지금 실어 갈 짐이고요.",
    'story.l1callGo.2': "급한 것부터 차가 차는 만큼 <b>이미 담아 놨어</b>. 상자를 누르면 빼고 넣을 수 있고.<br>지금 부르면 <b>{nowRev}c</b> 받고 배차비 {nowFee}c — <b>{nowNet}c 남아.</b> 아래 <b>호출</b> 눌러 봐. 카드를 다시 누르면 차를 물릴 수도 있어.",
    ...
    'story.l3campGo.1': '전단지 한 장은 내가 챙겨 뒀어 — 캠페인권이야. 쓰면 며칠 안에 짐이 몰려와. 열어 봐.',
    'story.l3campDone.1': '위에 내일·모레 봐. 늘었지? 캠페인권은 한 번 쓰면 끝이야. 또 필요하면 정산 마켓에서 사.',
    'story.l3campDone.2': '대신 조심해. 광고로 끌어온 짐을 반송시키면 소문이 두 배로 나빠져. <b>감당할 만큼만</b> 끌어와 — 창고가 빌 것 같을 때만.',
    ...
    'story.l3fragile.1': '⚠ 붙은 거 봤지? 깨지는 물건이야. 한길 차에도 실리긴 하는데, 완충이 없어서 <b>깨질 수 있어</b>.',
    ...
    'story.l3trust.3': '<b>기한보다 일찍</b> 보낼수록 오르고 — 들어온 날 보내면 제일 많이 — 늦게 보내면 깎여. 단계가 오르면 뭐가 하나씩 좋아져.',
    ...
    'story.l4cold.2': '창고 안 <b>냉장</b> 간판에 찬 칸이 적혀 있지? 저게 다 차면 곤란해져.',
    ...
    'story.l6frozen.2': '냉동 간판 보이지? 냉동은 냉장보다 칸이 적어. 먼저 빼는 게 좋아.',
    ...
    'prep.story': '창고장 안내',
    'prep.storyDesc': '박 반장이 첫 3개월 동안 옆에서 규칙을 알려 줍니다 (어느 런이든)',
    'menu.sfx': '효과음',
    'menu.bgm': '음악',
    'menu.guide': '안내',
    'menu.smsShort': '문자',
    ...
    'cal.arrivals': '물량 {pct}',
    'cal.event.seol': "설 연휴 — 업체 휴무 (차를 못 부름. 입고는 계속된다)",
    'cal.event.chuseok': "추석 연휴 — 업체 휴무 (차를 못 부름. 입고는 계속된다)",
    'cal.event.seol_rush': "설 앞 폭주 — 입고 ×1.6, 그 입고분 기한 −하루",
    'cal.event.chuseok_rush': "추석 앞 폭주 — 입고 ×1.6, 그 입고분 기한 −하루",
    'cal.event.newyear': "신정 — 업체 휴무",
    'cal.event.samil': "3·1절 — 업체 휴무",
    'cal.event.buddha': "부처님오신날 — 업체 휴무",
    'cal.event.children': "어린이날 — 업체 휴무",
    'cal.event.memorial': "현충일 — 업체 휴무",
    'cal.event.liberation': "광복절 — 업체 휴무",
    'cal.event.foundation': "개천절 — 업체 휴무",
    'cal.event.hangul': "한글날 — 업체 휴무",
    'cal.event.christmas': "성탄절 — 업체 휴무",
    'cal.event.gift': '선물 주간 — ⚠ 파손주의 보상 +10',
    'cal.event.sale': '쇼핑 행사 — 일반 폭주 ×1.5, 대량 배차비 +20%',
    'cal.kr.1.label': '신정·비수기',
    'cal.kr.1.note': '비수기 — 물량 −15%, 폭설 잦음, 이달은 운영비 인플레 없음',
    'cal.kr.1.sms': '새해 첫 달은 잠잠해. 숨 돌리면서 2월 설 준비.',
    'cal.kr.2.label': '설',
    'cal.kr.2.note': "설 — 물량 +30%, 선물세트(신선·농산·파손) ↑. 연휴 앞 닷새 폭주, 연휴 사흘 업체 휴무 (날짜는 그 해 음력)",
    ...
    'cal.kr.9.label': '추석',
    'cal.kr.9.note': "추석 — 물량 +25%, 선물세트(신선·농산·파손) ↑. 연휴 앞 닷새 폭주, 연휴 사흘 업체 휴무 (날짜는 그 해 음력)",
    ...
    'cal.kr.11.note': '김장철·쇼핑 행사 — 물량 +30%, 농산물 ↑, 8~12일차 행사 주간(일반 폭주, 대량 배차비 +20%)',
    ...
    'call.payLater': "📄 {n:보름 어음|한 달 어음}",
    'call.bonus': '보너스',
    'call.selected': "선택 <b>{n}</b>/{cap}개",
    'call.pickNone': '상자를 눌러 담으세요',
    ...
    'demo.cta': '정식판 보기',
    'demo.gateTitle': '정식판',
    'demo.gateBody': '가을·겨울이 이어집니다. 체험판 진행은 그대로 이어집니다.',
    'demo.rowMonths': '런',
    'demo.rowScenarios': '런',
    ...
    'feat.low': '{m}월 비수기',
    'feat.orders': '주문 ×{x}',
    'feat.ordersDays': '주문 ×{x} · {n}일',
    'feat.xDays': '×{x} · {n}일',
    'feat.off': '연휴 {n}일 차 없음',
    'feat.rush': '{h} 주문 폭주',
    'feat.h.seol': '설',
    'feat.h.chuseok': '추석',
    'feat.rain': '장마',
    ...
    'rank.title': '순위',
    'rank.loading': '불러오는 중…',
    'rank.fail': '순위를 불러올 수 없습니다',
    'rank.empty': '아직 기록이 없습니다',
    'rank.total': '{n}명',
    'rank.res': '{board} {r}위 / {n}명',
    'rank.newBest': '최고 기록 갱신',
  ...
  data:   {
    ...
    "CARRIERS": {
      ...
      "bulk1": {
        ...
        "short": "빠른손",
        "vehicle": "탑차",
        "desc": "속성 없는 택배(크기 1~2)를 탑차에 실어 보낸다. 일반 특화의 축 · 프리미엄 — 배차 +1·용량 +1·배차비 +20%"
      },
      "bulk2": {
        "name": "푸른길 로지스",
        "short": "푸른길",
        "vehicle": "완충 탑차",
        "desc": "속성 없는 택배(크기 1~2)를 탑차에 실어 보낸다. 일반 특화의 축 · 엘리트 — 배차 +2·용량 +2·배차비 +40% · ⚠ 파손 안전 추가"
      },
      "bulk3": {
        "name": "메가허브 물류",
        "short": "메가허브",
        "vehicle": "완충 탑차",
        "desc": "속성 없는 택배(크기 1~2)를 탑차에 실어 보낸다. 일반 특화의 축 · 마스터 — 배차 +3·용량 +3·배차비 +60% · ⚠ 파손 안전 추가"
      },
      "cold0": {
        "name": "새벽냉장",
        "short": "새벽",
      ...
      "cold1": {
        ...
        "short": "싱싱",
        "vehicle": "냉장 탑차",
        "desc": "신선·농산물 전문. 신선·농산물 보너스 · 프리미엄 — 배차 +1·용량 +1·배차비 +20%"
      },
      "cold2": {
        "name": "콜드체인 센터",
        "short": "콜드체인",
        "vehicle": "냉장·냉동 탑차",
        "desc": "신선·농산물 전문. 신선·농산물 보너스 · 엘리트 — 배차 +2·용량 +2·배차비 +40% · 🧊 냉동 가능 추가"
      },
      "cold3": {
        "name": "산지직송 물류",
        "short": "산지직송",
        "vehicle": "대형 냉장차",
        "desc": "신선·농산물 전문. 신선·농산물 보너스 · 마스터 — 배차 +3·용량 +3·배차비 +60% · 🧊 냉동 가능 추가 · 크기 7까지"
      },
      "frozen0": {
        "name": "빙하 냉동",
        "short": "빙하",
      ...
      "frozen1": {
        ...
        "short": "설원",
        "vehicle": "냉동 탑차",
        "desc": "냉동 전용. 냉동 보너스 · 프리미엄 — 배차 +1·용량 +1·배차비 +20%"
      },
      "frozen2": {
        "name": "영하 30",
        "short": "영하30",
        "vehicle": "냉동·냉장 탑차",
        "desc": "냉동 전용. 냉동 보너스 · 엘리트 — 배차 +2·용량 +2·배차비 +40% · ❄ 냉장 가능 추가"
      },
      "fragile0": {
        "name": "조심조심 운송",
        "short": "조심",
        "vehicle": "완충 밴",
        "desc": "파손주의 전문. 파손 없음, 파손 보너스 · 일반·농산물도 실음 · 표준 계약"
      },
      "pack0": {
        "name": "살살 택배",
        "short": "살살",
      ...
      "fragile1": {
        ...
        "short": "유리손",
        "vehicle": "완충 밴",
        "desc": "파손주의 전문. 파손 없음, 파손 보너스 · 일반·농산물도 실음 · 프리미엄 — 배차 +1·용량 +1·배차비 +20%"
      },
      "fragile2": {
        "name": "완충 마스터즈",
        "short": "완충",
        "vehicle": "대형 완충차",
        "desc": "파손주의 전문. 파손 없음, 파손 보너스 · 일반·농산물도 실음 · 엘리트 — 배차 +2·용량 +2·배차비 +40% · 크기 7까지"
      },
      "fragile3": {
        "name": "백자 물류",
        "short": "백자",
        "vehicle": "냉장 완충차",
        "desc": "파손주의 전문. 파손 없음, 파손 보너스 · 일반·농산물도 실음 · 마스터 — 배차 +3·용량 +3·배차비 +60% · ❄ 냉장 가능 추가 · 크기 7까지"
      },
      "intl0": {
        "name": "관세 브릿지",
        "short": "관세",
        "vehicle": "보세 트럭",
        "desc": "통관 대기 중인 🛃 를 즉시 통관·발송하고, 일반 화물도 싣는다(냉장 없음). 통관 보너스 · 8칸 · 표준 계약"
      },
      "intl1": {
        "name": "보세 익스프레스",
        "short": "보세",
        "vehicle": "보세 트럭",
        "desc": "통관 대기 중인 🛃 를 즉시 통관·발송하고, 일반 화물도 싣는다(냉장 없음). 통관 보너스 · 프리미엄 — 배차 +2·8칸·배차비 +20%"
      },
      "intl2": {
        "name": "월드게이트",
        "short": "월드게이트",
        "vehicle": "보세 완충 트럭",
        "desc": "통관 대기 중인 🛃 를 즉시 통관·발송하고, 일반 화물도 싣는다(냉장 없음). 통관 보너스 · 엘리트 — 배차 +4·12칸·배차비 +40% · ⚠ 파손 안전 추가"
      },
      "large0": {
        "name": "거인 화물",
        "short": "거인",
        "vehicle": "대형 트럭",
        "desc": "크기 4 이상 택배를 처리 (파손 안전). 대형 보너스 · 8칸(4칸 둘) · 표준 계약"
      },
      "large1": {
        "name": "태산 중량물",
        "short": "태산",
        "vehicle": "대형 트럭",
        "desc": "크기 4 이상 택배를 처리 (파손 안전). 대형 보너스 · 프리미엄 — 배차 +2·8칸·배차비 +20%"
      },
      "large2": {
        "name": "코끼리 특수운송",
        "short": "코끼리",
        "vehicle": "냉장 대형 트럭",
        "desc": "크기 4 이상 택배를 처리 (파손 안전). 대형 보너스 · 엘리트 — 배차 +4·12칸(4칸 셋)·배차비 +40% · ❄ 냉장 가능 추가"
      },
      "air0": {
        "name": "공항 화물 대리점",
        "short": "공항 대리점",
        "vehicle": "공항 셔틀 트럭",
        "desc": "수입상 짐을 공항 화물터미널까지 실어 나르는 포워더. 소형(1~2)만, 통관 대기 중 처리·파손 안전. 비싸지만 빠름 · 표준 계약"
      },
      "air1": {
        "name": "제트 포워딩",
        "short": "제트",
        "vehicle": "공항 셔틀 트럭",
        "desc": "공항 화물터미널 포워더. 통관 대기 중 처리·파손 안전. 비싸지만 빠름 · 프리미엄 — 배차 +1·용량 +1·배차비 +20% · 크기 4까지"
      },
      "rail0": {
        "name": "철도 터미널 셔틀",
        "short": "철도 셔틀",
        "vehicle": "터미널 트레일러",
        "desc": "화물역까지 한 번에 많이 실어 나르는 포워더. 파손 안전. 보상은 📄 보름 어음(다음 정산에 현금) · 표준 계약"
      },
      "rail1": {
        "name": "고속철 포워딩",
        "short": "고속철",
        "vehicle": "터미널 트레일러",
        "desc": "화물역 포워더, 고속 화물편 연결. 파손 안전 · 프리미엄 — 배차 +1·용량 +1·배차비 +20% · 어음 없이 즉시 입금"
      },
      "sea0": {
        "name": "파도 포워딩",
        "short": "파도",
        "vehicle": "항만 트레일러",
        "desc": "수입상 컨테이너를 항구까지 끌어다 주는 포워더. 크기 2 이상, 통관·파손 안전. 보상은 📄 한 달 어음(두 번째 정산에 현금) · 표준 계약"
      },
      "sea1": {
        "name": "대양 포워딩",
        "short": "대양",
        "vehicle": "항만 트레일러",
        "desc": "항만 포워더. 크기 2 이상, 통관·파손 안전 · 프리미엄 — 배차 +1·용량 +1·배차비 +20% · 📄 보름 어음"
      }
    },
    "FAMILIES": {
      "bulk": { "name": "대량" },
    ...
    "ENHANCEMENTS": {
      ...
      "seal": {
        "name": "신뢰도 인장",
        "desc": "선택한 계약의 신뢰도 경험치 +2"
      },
      "record": {
        "name": "장기 거래 기록",
        "desc": "선택한 계약의 신뢰도 경험치 +4"
      },
      "optFragile": {
        "name": "완충 포장 특약",
    ...
    "FACILITIES": {
      "expand1": {
        "name": "선반 랙 설치",
        "desc": "랙 8칸 — 크기 2 이하 택배만 올린다"
      },
      "expand2": {
        "name": "복층 올리기",
        "desc": "복층 12칸 — 크기 4 이하 택배만 올린다"
      },
      "expand3": {
        "name": "옆 칸 임대",
        "desc": "벽을 트고 바닥 +16칸 — 아무 크기나"
      },
      "cold1": {
        "name": "냉장고 증설",
        "desc": "냉장 용량 +4"
  ...
  meta:   {
    ...
    "PERKS": {
      ...
      "bundle": {
        ...
        "short": "4개↑ 싣으면 호출 무료(월1)"
      },
      "compact": {
        "name": "공간 최적화",
        "desc": "크기 4 이상 택배가 창고에서 1칸 덜 차지 (트럭 적재는 그대로)",
        "short": "큰 택배 창고 -1칸"
      },
      "coldpro": {
        "name": "냉장 전문가",
    ...
    "ACHIEVEMENTS": {
      ...
      "four_carriers": {
        "name": "네 업체",
        "desc": "계약 슬롯 4개를 서로 다른 업체로 채우고 완주"
      },
      "rich_clear": {
        "name": "부자 클리어",
        "desc": "자금 1,000 이상으로 완주"
      },
      "veteran": {
        "name": "베테랑",
        "desc": "회사 5개 해금"
      ...
      "kr_summer_clear": {
        "name": "여름을 넘기다",
        "desc": "여름 (6~8월) 완주 → 가을 런 해금"
      },
      "kr_autumn_clear": {
        "name": "가을을 넘기다",
        "desc": "가을 (9~11월) 완주 → 겨울 런 해금"
      },
      "holiday_clear": {
        "name": "명절 특수",
        "desc": "명절 폭주 기간에 택배 15개 배송"
      }
    }
  },
  };
