...
(function (root) {
  ...
  ui: {
    ...
    'intro.2': '이력서 마흔두 장. 합격은 없었다.',
    'intro.3': '갈 데가 없어서 나간 일당 일이었다.',
    'intro.4': '한 사장. 리어카 한 대로 시작한 사람.',
    'intro.8': '오늘이 첫날이다.',
    'card.han.name': '한 사장',
    'card.park.name': '박 반장',
    'intro.skip': '건너뛰기 ▸',
    'intro.5': '지난겨울, 한 사장이 말했다. — “자네한테 넘기고 싶네.”',
    'intro.6': '“여기서 배우면서 잘 굴려 봐. 값은 싸게 쳐주지.”',
    'intro.7': '박 반장. 새벽마다 같이 짐을 내리던 사람.',
    ...
    'story.l1intro.3': '지금 보내면 <b>{nowLoss}c 손해</b>야. 배차비는 한 칸을 싣든 다 싣든 똑같거든.<br>쌓아 뒀다 꽉 채워 보내는 게 이 일이야. 오늘은 <b>기다려</b>.',
