...
(function (root) {
  ...
  ui: {
    ...
    'sum.revenue': '배송 수익',
    'sum.opCost': '월말 운영비',
    'sum.opCostDetail': '임대 {rent} · 계약 유지 {contracts} · 시설 유지 {facilities}',
    'hud.feesDue': "후불 배차비 {n}c",
    'hud.debt': "부채 {n}c",
    ...
    'mk.priceMult': '가격 ×{n}',
    'slot.pickReplace': '슬롯을 고르세요. 같은 업체면 업그레이드·배차 추가, 다른 업체면 교체(잔여 배차·강화 소멸, 신뢰도는 유지).',
