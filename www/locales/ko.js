...
(function (root) {
  ...
  ui: {
    ...
    'media.ticketOnce': '집행비 포함',
    'media.ticketLeft': '{n}장',
    'camp.noTicket': '보유한 캠페인권이 없습니다 — 정산 마켓에서 살 수 있어요',
    'media.run': "집행",
    'growth.fleet': "차량",
    'growth.warehouse': "창고",
    ...
    'hv.camp.lv': '캠페인권은 마켓에서 산다 — 쓰면 없어진다. 캠페인 물량·캠페인 중 반송은 평판 벌점이 더 크다',
    ...
    'tierfx.label.0': '표준 계약', 'tierfx.label.1': '프리미엄', 'tierfx.label.2': '엘리트', 'tierfx.label.3': '마스터',
    'tierfx.trucks': '배차 +{n}대', 'tierfx.cap': '{n}칸', 'tierfx.fee': '배차비 +{n}%', 'tierfx.size': '크기 {n}까지',
    'tierfx.addCap.fragile': '⚠ 파손 안전 추가', 'tierfx.addCap.cold': '❄ 냉장 가능 추가', 'tierfx.addCap.frozen': '🧊 냉동 가능 추가', 'tierfx.addCap.customs': '🛃 통관 가능 추가',
    'tierfx.delay0': '어음 없이 즉시 입금', 'tierfx.delay1': '📄 보름 어음', 'tierfx.delay2': '📄 한 달 어음',
    'perkfx.trucks': '배차 +{n}대', 'perkfx.feeMult': '배차비 -{n}%', 'perkfx.rewardDelta': '{type} 보상 +{n}', 'perkfx.bonusDelta': '{type} 보너스 +{n}', 'perkfx.cap': '용량 +{n}칸',
    'perkfx.freezeOnCall': '호출한 날 신선·농산물 기한 정지', 'perkfx.coldZone': '냉장 구역 +{n}', 'perkfx.frozenZone': '냉동 구역 +{n}', 'perkfx.customsDelta': '통관 대기 -{n}일',
    'perkfx.noCustomsDelay': '통관 지연 이벤트 무효', 'perkfx.xlDelta': '초대형 점유 -{n}', 'perkfx.sizeMax': '크기 {n}까지', 'perkfx.customsBonus': '통관 대기 중 처리 시 +{n}',
    'perkfx.delay0': '어음 없이 즉시 입금', 'perkfx.delay1': '📄 보름 어음', 'perkfx.delay2': '📄 한 달 어음',
  ...
  data:   {
    ...
    "CARRIERS": {
      "bulk0": {
        ...
        "short": "한길",
        "vehicle": "탑차",
        "desc": "속성 없는 택배(크기 1~2)를 탑차에 실어 보낸다. 일반 특화의 축"
      },
      "bulk1": {
        "name": "빠른손 익스프레스",
        "short": "빠른손",
      ...
      "fragile0": {
        ...
        "short": "조심",
        "vehicle": "완충 밴",
        "desc": "파손주의 전문. 파손 없음, 파손 보너스 · 일반·농산물도 실음"
      },
      "pack0": {
        "name": "살살 택배",
        "short": "살살",
      ...
      "intl0": {
        ...
        "short": "관세",
        "vehicle": "보세 트럭",
        "desc": "통관 대기 중인 🛃 를 즉시 통관·발송하고, 일반 화물도 싣는다(냉장 없음). 통관 보너스"
      },
      "intl1": {
        "name": "보세 익스프레스",
        "short": "보세",
      ...
      "air0": {
        ...
        "short": "공항 대리점",
        "vehicle": "공항 셔틀 트럭",
        "desc": "수입상 짐을 공항 화물터미널까지 실어 나르는 포워더. 소형(1~2)만, 통관 대기 중 처리·파손 안전. 비싸지만 빠름"
      },
      "air1": {
        "name": "제트 포워딩",
        "short": "제트",
        "vehicle": "공항 셔틀 트럭",
        "desc": "공항 화물터미널 포워더. 통관 대기 중 처리·파손 안전. 비싸지만 빠름"
      },
      "rail0": {
        "name": "철도 터미널 셔틀",
        "short": "철도 셔틀",
        "vehicle": "터미널 트레일러",
        "desc": "화물역까지 한 번에 많이 실어 나르는 포워더. 파손 안전. 보상은 📄 보름 어음(다음 정산에 현금)"
      },
      "rail1": {
        "name": "고속철 포워딩",
        "short": "고속철",
        "vehicle": "터미널 트레일러",
        "desc": "화물역 포워더, 고속 화물편 연결. 파손 안전"
      },
      "sea0": {
        "name": "파도 포워딩",
        "short": "파도",
        "vehicle": "항만 트레일러",
        "desc": "수입상 컨테이너를 항구까지 끌어다 주는 포워더. 크기 2 이상, 통관·파손 안전. 보상은 📄 한 달 어음(두 번째 정산에 현금)"
      },
      "sea1": {
        "name": "대양 포워딩",
        "short": "대양",
        "vehicle": "항만 트레일러",
        "desc": "항만 포워더. 크기 2 이상, 통관·파손 안전"
      }
    },
    "FAMILIES": {
      "bulk": { "name": "대량" },
