...
(function (root) {
  ...
  ui: {
    ...
    'story.l1last.2': '이 보름치는 내가 정리해서 영감님한테 보낼게.<br>뭐라고 쓸지는… 자네가 남은 날 하는 거 보고.',
    ...
    'letter.1.good': '박 반장 글씨로 보름치가 왔더군. 하나도 안 흘렸다고 적혀 있었네.<br><br>솔직히 말하면 나는 자네가 한 달쯤 하다 그만둘 줄 알았어.<br>열여섯에 아버지 심부름으로 왔을 때 그 표정을 아직 기억하거든. 무거운 거 들면 꼭 그 표정이야.<br><br>남은 두 달 반, 계속 해 보게.',
