...
(function (root) {
  ...
  ui: {
    ...
    'ct.body': '위 목적물의 값을 {price}c 로 한다. 오늘 계약금 {down}c 를 받았다.<br>잔금 {rest}c 는 남은 열 달 안에 채우면 되고, 이자는 붙이지 않는다.<br>매수인은 들어온 물건을 제 날짜에 내보낼 것. 그것 말고는 조건이 없다.',
    'ct.stamp': '도장 찍기',
    'ct.price': '매매 대금',
    'ct.down': '계약금 (오늘)',
    'ct.rest': '잔금 (남은 열 달)',
    'ct.after': '잔금 <b>{rest}c</b> 를 열 달 안에 — 남은 자금 {left}c 로 시작합니다.',
    'ct.stampMark': '韓',
    'ct.done': '창고를 넘겨받는다',
    'lv.sub.1': '빈 창고',
    'lv.sub.2': '두 번째 트럭',
