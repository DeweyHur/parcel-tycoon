  ...
  meta:   {
    ...
    "COMPANIES": {
      ...
      "postal": {
        "name": "국영 우편",
        "tag": "안정형 · 장기전",
        "passive": "공공 서비스: 운영비 180·배차비 45c 고정. 직접 배송 +1개. 스트레스 10 이상이면 월초 -2",
    ...
    "SCENARIOS": {
      ...
      "peak": {
        "name": "성수기",
        "desc": "입고 ×2.2, 폭주 턴 5회(폭주 입고분 기한 -2), 반송 유예 2턴. 보상 +10, 가격 ×1.3, 시작 호출 +2",
        "win": "2개월 생존 + 50개 처리",
      ...
      "strike": {
        "name": "파업",
        "desc": "매월 운송 업체 1종 호출 불가 (월초 공지). 입고 +20%, 운영비 +30",
        "win": "3개월 생존",
        "recommend": "스타트업"
      },
      "port": {
