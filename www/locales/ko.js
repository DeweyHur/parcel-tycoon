...
(function (root) {
  ...
  ui: {
    ...
    'story.callModal.1': "'급한 순 자동 선택'을 눌러 봐. 급한 것부터 차에 담아 줘.<br>칸이 남으면 하나 더 얹고 넘치면 빼. 한 대 더 부르면 배차비도 한 번 더 나가.",
    ...
    'story.m2.2': '택배마다 앞에 아이콘 보이지? 누가 보냈는지야. 기한 안에 보내면 그 고객 신뢰가 오르고, 신뢰가 오르면 물량이랑 단가가 같이 올라.<br>폐기하면 −3. 자꾸 그러면 거래가 끊겨.',
    ...
    'story.rain.2': '대기 버튼 눌러 봐. 거기에 적재 정리가 있어 — 뭘 안에 두고 뭘 밖에 둘지 고를 수 있어.',
