...
(function (root) {
  ...
  ui: {
    ...
    'how.1.t': '택배가 쌓인다',
    'how.1.d': '매 턴 택배가 들어옵니다. 창고가 넘치면 밖에 쌓이고, 밖은 젖고 도둑맞습니다.',
    'how.2.t': '트럭을 꽉 채워 보낸다',
    'how.2.d': '트럭 값은 <b>부를 때마다</b> 나갑니다. 두 개만 실으면 개당 16c, 꽉 채우면 개당 4c. <b>안 부르고 기다리는 턴이 정답일 때가 많습니다.</b>',
    'how.3.t': '1년을 버틴다',
    'how.3.d': '3월에 인수해서 내년 2월까지. 돈이 마르거나 창고가 터지면 끝입니다.',
    ...
    'btn.close': '닫기',
    'common.none': '없음',
    'fmt.calMonth': "{cal}월<small>·{n}개월차</small>",
    'story.name': '박 반장',
    'story.skip': '건너뛰기 ×',
    'story.next': '다음 ▶',
    'story.ok': '알겠어',
    ...
    'rep.greet.rail': '{center} 노 기사요. 열차는 한 번에 {cap}칸이나 실려. 대신 돈은 다음 턴에 들어와. {trucks}대, 대당 {fee}c.',
    ...
    'story.intro.3': '제일 중요한 얘기 하나만 할게. 차는 매일 부르는 게 아니야. {name}은 한 대에 {fee}c씩 나가거든.<br>꽉 채워서 보낼수록 한 개당 싸져. 그러니까 오늘은 그냥 <b>기다려</b>.',
    ...
    'call.autoTrim': '꽉 차는 차까지만 담았어요. 더 보내려면 직접 고르거나, 대기 턴에 직접 배송하세요.',
    ...
    'story.handOff.1': '자, 기본은 다 알려 줬어. 이번 달 남은 턴은 자네가 해봐 — 쌓이면 부르고, 아니면 대기. 그게 전부야.<br>새로운 게 나오면 그때 또 끼어들게.',
    ...
    'story.callModal.1': '버튼에 <b>실을 것 {openVol}/{openCap}칸 · {openFee}c</b> 이렇게 적혀 있었지?<br>차 한 대가 {openCap}칸인데 지금 이 계약으로 실을 게 {openVol}칸 있다는 뜻이야. 한 대 부를 때마다 {openFee}c 나가고.<br>위 게이지가 그 {openVol}/{openCap}을 그림으로 보여주는 거야.',
    'story.callGo.1': '담겼지? 게이지가 80% 넘으면 남는 장사야. 아래 목록을 눌러서 넣고 뺄 수도 있어.',
    'story.callGo.2': '됐으면 호출 버튼. 호출하면 그대로 한 턴이 지나가.',
    ...
    'story.usage76.2': '위에 \'입고 예정\' 보이지? 다음 두 턴에 뭐가 얼마나 오는지 미리 보여.<br>그걸 보고 기다릴지 부를지 정해.',
    ...
    'story.noContract.1': '저 택배, 지금 계약으로는 실을 차가 없어. 이럴 땐 대기 버튼을 눌러 봐 — 직접 배송이라고, 기다리는 턴에 내가 하나씩 나르는 거야.',
    ...
    'story.waitGo.1': '골랐으면 아래 버튼. 이번 턴은 기다리면서 그거 하나 직접 나르는 거야.',
    ...
    'cal.title': '한 해 달력',
    'cal.thisMonth': '이번 달',
    'cal.eventTurns': '{a}~{b}턴',
    'cal.arrivals': '물량 {pct}',
    'cal.event.holiday_rush': '명절 폭주 — 그 턴 입고 ×1.6, 기한 −1',
    'cal.event.holiday_off': '연휴 — 업체 휴무 (호출 불가, 입고는 연휴 뒤 첫 턴에 몰림)',
    ...
    'cal.kr.2.label': '설',
    'cal.kr.2.note': '설 — 물량 +30%, 선물세트(신선·농산·파손) ↑, 2~4턴 폭주, 5~6턴 연휴 휴무',
    ...
    'cal.kr.5.note': '가정의 달 — 물량 +5%, 선물(파손주의) ↑, 5~7턴 선물 주간(⚠ 보상 +10)',
    'cal.kr.5.sms': '',
    ...
    'cal.kr.7.note': '장마·폭염 — 신선·냉동 ↑, 물량 −5%, 폭염 경보 턴 월 1회',
    'cal.kr.7.sms': '폭염. 냉장 물건 밖에 두면 그 턴에 끝이야. 냉장 구역 넓힐 거면 지금.',
    'cal.kr.8.label': '폭염·휴가',
    'cal.kr.8.note': '폭염·휴가 — 일반 −10%p, 신선 ↑, 물량 −10%',
    'cal.kr.8.sms': '휴가철이라 일반은 좀 줄고 신선이 많아. 냉장 차 한 대 더 잡아 둬.',
    'cal.kr.9.label': '추석',
    'cal.kr.9.note': '추석 — 물량 +25%, 선물세트(신선·농산·파손) ↑, 2~4턴 폭주, 5~6턴 연휴 휴무',
    ...
    'cal.kr.11.note': '김장철·쇼핑 행사 — 물량 +30%, 농산물 ↑, 7~10턴 행사 주간(일반 폭주, 대량 배차비 −10%)',
    ...
    'mk.sold': '판매됨',
    'mk.currentContracts': '현재 계약 — 배차는 소모품: 월초에 채워지지 않고 여기서 가득 충전만{keep}',
  ...
  data:   {
    ...
    "CARRIERS": {
      ...
      "rail0": {
        ...
        "short": "철마",
        "vehicle": "화물 열차",
        "desc": "파손 안전, 한 번에 많이. 보상은 다음 턴 입금 · 표준 계약"
      },
      "rail1": {
        "name": "고속철 카고",
        "short": "고속철",
        "vehicle": "고속 화물열차",
        "desc": "파손 안전, 한 번에 많이. 보상은 다음 턴 입금 · 프리미엄 — 배차 +1·용량 +1·배차비 −10% · 입금 즉시"
      },
      "sea0": {
        "name": "파도 해운",
        "short": "파도",
        "vehicle": "컨테이너",
        "desc": "통관 컨테이너, 크기 2 이상, 파손 안전. 보상은 2턴 뒤 입금 · 표준 계약"
      },
      "sea1": {
        "name": "대양 컨테이너",
        "short": "대양",
        "vehicle": "컨테이너",
        "desc": "통관 컨테이너, 크기 2 이상, 파손 안전. 보상은 2턴 뒤 입금 · 프리미엄 — 배차 +1·용량 +1·배차비 −10% · 입금 지연 1턴"
      }
    },
    "FAMILIES": {
      "bulk": { "name": "대량" },
  ...
  meta:   {
    ...
    "DIFFICULTIES": {
      "rookie": {
        "name": "수습",
        "desc": "입고 ×0.85, 운영비 -30, 배차비 ×0.8, 가격 ×0.9, 도난·파손·배상 ×0.5, 예정 3턴, 스트레스 한계 24. 점수 ×0.7. 해금 도전과제 인정 안 됨"
      },
      "normal": {
        "name": "정규",
    ...
    "COMPANIES": {
      ...
      "thrifty": {
        "name": "짠돌이 운송",
        "tag": "절약형의 극단",
        "passive": "알뜰 계약: 모든 마켓 가격·배차비 -20%. 대기한 턴마다 다음 호출 차량 용량 +1칸 (최대 +3)",
    ...
    "SCENARIOS": {
      ...
      "peak": {
        "name": "성수기",
        "desc": "달력의 11~12월 컷(4개월차 물량으로 시작). 쇼핑 행사·연말 물량 위에 폭주 턴 3회(기한 -2), 반송 유예 2턴. 보상 +10, 가격 ×1.3, 시작 배차 +2",
        "win": "11~12월 생존 + 50개 처리",
        "recommend": "도심 퀵 · 강철 창고"
      },
      "heatwave": {
        "name": "폭염",
        "desc": "달력의 7~8월 컷(5개월차 물량으로 시작). 신선 비율 ↑, 입고 +10%, 상온 부패 3배, 폭염 경보 턴 월 3회",
      ...
      "blackfriday": {
        "name": "블랙 프라이데이",
        "desc": "11월 한 달 지옥. 쇼핑 행사 위에 입고 ×1.4, 폭주 턴 3회, 가격 ×1.4, 반송 유예 4턴. 보상 +15, 시작 배차 +3",
        "win": "11월 생존 + 30개 처리",
        "recommend": "도심 퀵 · 짠돌이"
      },
      "audit": {
        "name": "감사",
        "desc": "모든 기한 -1턴, 기한 초과 보상 -50%, 월초 스트레스 +1",
        "win": "12개월 생존 + 기한 초과 처리 12개 이하",
        "recommend": "국영 우편 · 유리방"
      },
      "moving": {
        "name": "이사철",
        "desc": "이사센터 포함, 보관 제안 5턴마다 보장, 보관료 ×1.5",
