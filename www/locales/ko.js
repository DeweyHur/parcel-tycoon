...
(function (root) {
  ...
  ui: {
    ...
    'intro.8': '“자네가 봄 한철만 굴려 봐. 할 만하면 그때 싸게 넘겨주지.”',
    ...
    'story.l6last.2': '솔직히 나는 보름쯤 하다 그만둘 줄 알았어. 영감님한테는 그렇게 말 안 했지만.',
    ...
    'letter.2.bad': '두 달치 잘 받았네. 차가 없어서 못 보낸 게 좀 있었다고.<br><br>그건 자네 잘못이 아니라 셈을 아직 못 해 본 거야. 한 번 겪으면 다시는 안 그래.<br><br>남은 두 달, 계속 해 보게.',
    ...
    'letter.3.bad': '두 달치 받았네. 비에 좀 젖었다고 적혀 있었어.<br><br>지붕 없는 데 물건을 두면 그렇게 되는 거지. 마당은 어디까지나 임시야.<br>창고를 넓히든, 더 자주 보내든 — 방법은 자네가 고르게.<br><br>남은 한 달 반, 부탁하네.',
    ...
    'letter.4.bad': '두 달치 받았네. 몇 개 상했다고 적혀 있었어.<br><br>찬 건 기다려 주질 않아. 나도 그거 배우느라 봄 하나를 통째로 썼네.<br><br>남은 한 달. 이제 진짜 바쁜 철이야.',
    ...
    'letter.1.good': '박 반장 글씨로 두 달치가 왔더군. 하나도 안 흘렸다고 적혀 있었네.<br><br>솔직히 말하면 나는 자네가 한 달쯤 하다 그만둘 줄 알았어.<br>열여섯에 아버지 심부름으로 왔을 때 그 표정을 아직 기억하거든. 무거운 거 들면 꼭 그 표정이야.<br><br>남은 두 달 반, 계속 해 보게.',
    'letter.1.bad': '박 반장 글씨로 두 달치가 왔더군. 몇 개 흘렸다고.<br><br>나도 첫해엔 남의 이삿짐을 통째로 비 맞혔네. 그 집 아주머니가 나중에 이십 년 단골이 됐지.<br>일은 안 틀리는 사람이 아니라 안 도망가는 사람이 배우는 거야.<br><br>남은 두 달 반, 계속 해 보게.',
