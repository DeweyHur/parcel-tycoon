...
(function (root) {
  ...
  ui: {
    ...
    'how.2.d': '트럭 값은 <b>부를 때마다</b> 나갑니다. 시작 트럭(7칸)에 두 개만 실으면 개당 32c, 꽉 채우면 개당 16c. <b>절반도 못 채우면 부를수록 손해</b>라 안 부르고 기다리는 것이 정답일 때가 많습니다.',
    ...
    'intro.1': '2027년 3월 2일, 월요일.',
    'intro.2': '이 창고에는 주인이 있다.',
    'intro.3': '한종수. 마흔에 리어카 한 대로 시작했다고 했다.',
    'intro.4': '내가 처음 온 건 열여섯, 아버지 심부름이었다.',
    'intro.8': '“자네가 한 해만 굴려 봐. 할 만하면 그때 싸게 넘겨주지.”',
    'intro.9': '그래서 오늘부터 열두 달이다.',
    'intro.10': '혼자 하는 건 아니다. 박 반장님이 올해 내내 붙는다.',
    'intro.11': '오늘이 첫날이다.',
    'card.han.name': '한종수',
    'card.han.desc': '이 창고의 주인',
    'card.park.name': '박 반장',
    'card.park.desc': '이 창고 반장',
    'intro.skip': '건너뛰기 ▸',
    'intro.5': '그 뒤로는 손이 모자란 날마다 내가 왔다.<br>짐을 같이 내리고, 국수를 같이 먹고.',
    'intro.6': '값을 쳐 준 적은 없다. 나도 받을 생각을 안 했다.',
    'intro.7': '작년 겨울에 영감님이 말했다. — “내가 이제 못 들겠어.”',
    'story.name.han': '한 사장님',
    'story.name.mart': '큰마트 김 대리',
    'story.l1intro.4': '그러니까 지금 보내시면 <b>{nowLoss}c 손해</b>예요.<br>배차비는 한 칸을 싣든 {nowCap}칸을 싣든 똑같이 {nowFee}c라서.',
    'story.l1intro.5': '봤지? 그래서 오늘은 <b>기다려</b>.<br>쌓아 뒀다 꽉 채워 보내는 게 이 일이야.',
    'story.l1first.3': '차를 꽉 채울수록 그 몫이 커져. 당분간은 이게 전부야.',
    'story.l1last.2': '두 달치는 내가 정리해서 영감님한테 보낼게.<br>뭐라고 쓸지는… 자네가 남은 날 하는 거 보고.',
    'story.l1intro.1': '왔구만. 영감님한테 얘기 들었어.<br>나는 박 반장. 올해는 계속 같이 해.',
    'story.l1intro.2': '한길 물류 여 실장입니다. 인사차 들렀어요.<br>오늘 한 대 부르시게요?',
    'story.l1intro.3': '저희 차는 <b>{nowCap}칸</b>, 한 번 부르면 <b>{nowFee}c</b>예요.<br>지금 창고에 있는 건 {nowVol}칸 — 받는 값이 {nowRev}c고요.',
    ...
    'story.l1free.1': '기본은 끝. 쌓이면 부르고, 아니면 기다려.<br>나머지는 자네가 해봐 — 옆에서 보고 있을게.',
    ...
    'story.l2intro.1': '두 달 잘 넘겼어. 도장도 찍었고, 이제 간판이 자네 거지.<br>그럼 슬슬 진짜 살림 얘기를 해야겠네.',
    'story.l2intro.2': '여기 계약 카드 밑에 <b>배차 {trucks}대</b>라고 붙었지? 서장 때는 안 보이던 거야.',
    'story.l2intro.3': '차를 한 번 부를 때마다 저게 하나씩 준다.<br>영감님이 미리 끊어 둔 게 딱 저만큼이거든.',
    ...
    'story.l2market.2': '배차 충전, 계약 한도, 창고 확장 — 살 수 있는 건 달마다 좀 달라져.<br>한 달에 살 수 있는 개수도 정해져 있고.',
    ...
    'story.l3intro.1': '장마 들어왔어. 여름은 여기가 제일 바쁘고 제일 골치야.',
    ...
    'story.l3rain.2': '대기 버튼 눌러 봐. 안팎을 바꿀 수 있어.',
    ...
    'story.l3self.1': '차가 없네. 이럴 땐 <b>직접 배송</b>이 있어 — 대기하는 날에 내가 하나씩 나르는 거야.',
    'story.l3self.2': '배송비가 좀 나가는데 반송보다는 싸. 대기 버튼 눌러 봐.',
    ...
    'story.l3last.1': '장마 끝나 가네. 가을부터는 물건이 좀 달라져 — 그건 그때 얘기하고.',
    // ----- 3장 (9~10월): 찬 것 · 깨지는 것 · 이름이 있는 화주 -----
    'story.l4intro.1': '가을이야. 이제부터 오는 물건이 달라져.<br>지금까지는 그냥 상자였잖아. 이제 <b>상하는 것</b>도 오고 <b>깨지는 것</b>도 와.',
    ...
    'story.l4last.1': '가을도 끝나 가네. 겨울은… 좀 다르지. 그건 다음에.',
    // ----- 4장 (11~12월): 평판 · 보험 · 보관 · 대형 -----
    'story.l5intro.1': '11월이야. 김장에 쇼핑 행사에, 12월 연말까지 — 한 해에서 제일 바쁜 두 달이지.',
    ...
    'story.l5last.1': '연말도 다 갔네. 한 해가 거의 다 돌았어.',
    'story.l5last.2': '남은 건 설 물량 하나야. 그거 넘기면 진짜 자네 창고고, 잔금도 거기서 끝나.',
    // ----- 5장 (1~2월): 마지막 겨울 -----
    'story.l6intro.1': '새해야. 1월은 조용해 — 한 해에서 제일 한가한 달이지.',
    'story.l6intro.2': '숨 돌릴 때 준비해 둬. 2월엔 설이 있고, 그게 마지막 고비야.<br>그거 넘기면 끝이고, 잔금도 거기서 털어.',
    ...
    'story.l6full.1': '잠깐. 계약 자리가 <b>넷이 다 찼어</b>. 하나 더 살 데가 없지.',
    'story.l6full.2': '이럴 땐 계약 말고 <b>특약</b>이야. 지금 있는 계약에 조건을 하나 더 붙이는 거지 —<br>자리를 안 먹어. 대신 계약 하나에 특약은 하나만.',
    'story.l6full.3': '저거 사서 맞는 계약에 붙여 봐. 그럼 그 차가 ❆ 도 받아 줘.<br>이게 마지막으로 가르칠 거야. 자리가 모자랄 땐 늘리는 게 아니라 <b>붙이는 거</b>다.',
    'story.l6stuck.1': '저거 아직 실을 데가 없네. 택배를 눌러 보면 뭐가 필요한지 나와.',
    'story.l6stuck.2': '자리가 다 찼으면 특약을 찾고, 그것도 없으면 계약을 하나 갈아타는 수밖에 없어.',
    'story.l6last.1': '마지막 보름이네. 작년 이맘때 자네가 여기 처음 왔었지.',
    'story.l6last.2': '솔직히 나는 두 달쯤 하다 그만둘 줄 알았어. 영감님한테는 그렇게 말 안 했지만.',
    'story.l6last.3': '이거 넘기면 끝이야. 잔금 털고, 간판 제대로 달고.<br>나는 그다음엔 가끔 커피나 마시러 올게.',
    'story.l1last.1': '벌써 마지막 보름이네. 이제 자네가 나보다 빨라.',
    'rpt.title': '{ch} 리포트',
    'rpt.by': '박 반장 정리',
    'rpt.sub': '{months}개월치를 영감님께 보냅니다',
    'rpt.delivered': '처리',
    'rpt.onTime': '정시',
    'rpt.trouble': '반송 · 폐기',
    'rpt.cash': '남은 자금',
    'rpt.unit': '{n}개',
    'rpt.good': '“잘 붙었습니다. 하나도 안 흘렸고, 늦은 것도 거의 없습니다.<br>제가 스무 해 하면서 첫 두 달에 이런 사람 못 봤습니다.”',
    'rpt.ok': '“쓸 만합니다. 몇 개 늦긴 했는데, 늦는 이유를 알고 늦더군요.<br>그건 배우는 중이라는 뜻입니다.”',
    'rpt.bad': '“아직 손이 익지 않았습니다. 흘린 게 좀 있습니다.<br>그래도 도망은 안 갔습니다. 그건 쳐 줘야지요.”',
    'rpt.next': '영감님 편지 읽기',
    'letter.title': '한 사장님 편지',
    'letter.toName': '{name} 사장 보게',
    'letter.toYou': '자네 보게',
    'letter.sign': '한종수',
    'letter.close': '접어 넣는다',
    'letter.generic.good': '박 반장 글씨로 두 달치가 왔더군. 숫자보다 그 사람 말투가 좋았네.<br><br>나는 이 창고를 마흔에 샀어. 그때는 리어카 한 대였지.<br>자네가 지금 서 있는 자리가 내가 마흔에 섰던 자리야. 별거 없지? 원래 별거 없어.<br><br>다음 두 달도 부탁하네.',
    'letter.generic.bad': '박 반장 글씨로 두 달치가 왔더군. 몇 개 흘렸다고.<br><br>괜찮네. 나도 첫해에 남의 이삿짐을 통째로 비 맞혔어.<br>그 집 아주머니가 이십 년 단골이 됐지. 사과를 제대로 하면 그렇게 되더군.<br><br>다음 두 달도 부탁하네.',
    'letter.2.good': '박 반장 글씨로 두 달치가 또 왔네. 차를 꽉 채워 보낸다고 적혀 있었어.<br><br>배차라는 게 원래 그래. 돈으로 사는 건데 안 쓰면 그냥 사라지지.<br>나도 그거 아는 데 삼 년 걸렸네. 자네는 두 달 만에 알았고.<br><br>간판은 달았나? 아직이면 서둘지 말고.',
    'letter.2.bad': '두 달치 잘 받았네. 차가 없어서 못 보낸 게 좀 있었다고.<br><br>그건 자네 잘못이 아니라 셈을 아직 못 해 본 거야. 한 번 겪으면 다시는 안 그래.<br><br>남은 여덟 달, 계속 해 보게.',
    'letter.3.good': '장마를 넘겼구먼. 마당에 물건 내놓고 비 맞힌 적 없다고 적혀 있네.<br><br>나는 첫해 장마에 이삿짐 한 채를 통째로 적셨어. 그 집 아주머니가 나중에 이십 년 단골이 됐지만,<br>그건 운이 좋았던 거고 자네처럼 하는 게 맞아.<br><br>여름 지나면 물건이 달라져. 박 반장 말 잘 듣고.',
    'letter.3.bad': '두 달치 받았네. 비에 좀 젖었다고 적혀 있었어.<br><br>지붕 없는 데 물건을 두면 그렇게 되는 거지. 마당은 어디까지나 임시야.<br>창고를 넓히든, 더 자주 보내든 — 방법은 자네가 고르게.<br><br>남은 여섯 달, 부탁하네.',
    'letter.4.good': '가을치가 왔네. 찬 물건 하나도 안 상하고 넘겼다고.<br><br>냉장은 돈이 든다고 미루는 사람이 많은데, 한 번 상하면 그게 더 비싸.<br>자네는 그 계산을 이미 한 거고.<br><br>화주들 이름도 여럿 적혀 있더군. 사람이 붙기 시작했다는 뜻이야.',
    'letter.4.bad': '두 달치 받았네. 몇 개 상했다고 적혀 있었어.<br><br>찬 건 기다려 주질 않아. 나도 그거 배우느라 여름 하나를 통째로 썼네.<br><br>남은 넉 달. 이제 진짜 바쁜 철이야.',
    'letter.5.good': '연말치가 왔네. 그 물량을 하나도 안 흘렸다고.<br><br>솔직히 놀랐어. 11월하고 12월은 나도 매년 몇 개씩 놓쳤거든.<br>이 동네에서 자네 이름을 안다는 게 이제 빈말이 아니야.<br><br>설만 넘기면 끝이야. 마지막까지 부탁하네.',
    'letter.5.bad': '연말치 받았네. 몇 개 흘렸다고.<br><br>그 두 달은 원래 그래. 나도 스무 해 하면서 한 번도 깨끗하게 넘긴 적이 없어.<br>중요한 건 자네가 아직 여기 있다는 거지.<br><br>설 하나 남았네.',
    'letter.6.good': '설까지 넘겼구먼.<br><br>한 해를 다 돌았어. 삼월에 처음 왔을 때 자네 표정이 아직 기억나는데,<br>그때는 리어카도 못 끌 것 같더니.<br><br>이제 거기는 내 창고가 아니야. 축하하네.',
    'letter.6.bad': '설까지 넘겼구먼.<br><br>몇 개 흘렸다고 적혀 있었지만, 한 해를 다 돌았다는 게 중요한 거야.<br>나도 첫해엔 훨씬 더 흘렸네.<br><br>이제 거기는 내 창고가 아니야. 축하하네.',
    'letter.1.good': '박 반장 글씨로 두 달치가 왔더군. 하나도 안 흘렸다고 적혀 있었네.<br><br>솔직히 말하면 나는 자네가 한 달쯤 하다 그만둘 줄 알았어.<br>열여섯에 아버지 심부름으로 왔을 때 그 표정을 아직 기억하거든. 무거운 거 들면 꼭 그 표정이야.<br><br>남은 열 달, 계속 해 보게.',
    'letter.1.bad': '박 반장 글씨로 두 달치가 왔더군. 몇 개 흘렸다고.<br><br>나도 첫해엔 남의 이삿짐을 통째로 비 맞혔네. 그 집 아주머니가 나중에 이십 년 단골이 됐지.<br>일은 안 틀리는 사람이 아니라 안 도망가는 사람이 배우는 거야.<br><br>남은 열 달, 계속 해 보게.',
    ...
    'ct.body': '위 목적물의 값을 {price}c 로 한다. 오늘 계약금 {down}c 를 받았다.<br>잔금 {rest}c 는 두 달마다 한 회차씩, 남은 열 달 안에 나눠 낸다. 이자는 붙이지 않는다.<br>매수인은 들어온 물건을 제 날짜에 내보낼 것. 그것 말고는 조건이 없다.',
    'inst.modal': '잔금',
    ...
    'inst.pay': '오늘 낸 돈',
    'inst.rest': '남은 잔금',
    'inst.ok': '영감님한테 부쳤다. 남은 돈은 {left}c.',
    'inst.short': '{n}c 가 모자란다. 영감님은 "됐다, 다음에 같이 보내"라고만 했다.',
    'inst.cleared': '값을 다 치렀다. 이제 이 창고는 내 것이다.',
    'inst.btn': '부친다',
    'inst.btnFinal': '계약서를 받는다',
    'ct.titleFinal': '창 고 매 매 계 약 서',
    'ct.bodyFinal': '위 목적물의 값을 전액 수령하였다. 매도인은 목적물을 매수인에게 완전히 넘긴다.<br>한 해 동안 하나도 안 흘렸다. 그거면 됐다.',
    'ct.doneFinal': '창고를 넘겨받는다',
    'ct.stamp': '도장 찍기',
    'ct.price': '매매 대금',
    'ct.down': '계약금 (오늘)',
    'ct.rest': '잔금 (두 달마다 분납)',
    'ct.after': '잔금 <b>{rest}c</b> 를 두 달마다 나눠 — 남은 자금 {left}c 로 시작합니다.',
    'ct.stampMark': '韓',
    'ct.done': '창고를 넘겨받는다',
    'lv.sub.1': '빈 창고',
    'lv.sub.2': '두 번째 트럭',
    ...
    'ch.end.3': '비가 그치고, 마당이 말랐다.',
    'ch.end.4': '찬 것들이 제 자리를 찾았다.',
    'ch.end.5': '이름이 동네를 넘었다.',
    'ch.end.6': '설 물량이 마지막으로 빠져나갔다.',
    'lv.ch.1': '서장',
    'lv.ch.2': '1장',
    'lv.ch.3': '2장',
    'lv.ch.4': '3장',
    ...
    'lv.nameBody': '두 달 굴려 봤으니 이제 간판을 달아야지. 값은 값대로 쳐 줄 테니까.<br>계약서에 뭐라고 적을까?',
    ...
    'lv.continue': '이어하기',
    'lv.restart': '처음부터',
    'lv.pickAsk': '{ch}을 처음부터 다시 합니다. 지금 진행 중인 런은 사라집니다.',
    'lv.pickGo': '다시 하기',
    'lv.doneGo': '다음',
    'sum.toNext': '{n} 시작',
    'help.l1': '<b>이 일의 전부</b><br>택배가 영업일마다 들어옵니다. 쌓아 뒀다가 <b>차를 꽉 채워</b> 보낼수록 택배 한 개당 비용이 싸집니다.<br><br><b>기한</b> 택배마다 ⏳ 가 붙어 있습니다. 넘기면 보상이 깎이고, 이틀을 더 넘기면 반송됩니다.<br><b>대기</b> 차를 부르지 않는 날입니다. 하루가 지나고 택배가 더 들어옵니다.<br><b>창고</b> 다 차면 남는 것은 마당에 쌓입니다.<br><b>일요일</b> 쉬는 날입니다. 입고도 기한도 멈춥니다.<br><b>정산</b> 보름마다 수입에서 배차비와 임대료를 뺍니다.<br><br><span style=\'color:var(--dim)\'>나머지는 박 반장이 그때그때 알려 줍니다.</span>',
    'title.story': '인수인계',
