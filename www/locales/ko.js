...
(function (root) {
  ...
  ui: {
    ...
    'story.l2intro.2': "여기 계약 카드 밑에 <b>배차 {trucks}대</b>라고 붙어 있지?<br>전에는 한 사장이 챙기던 거라 자네가 볼 일이 없던 숫자야.",
    ...
    'story.l3invest.1': "저 아래 <b>투자</b>, 이제 자네가 쓸 때가 됐어.<br>번 돈을 창고·차·홍보에 도로 넣는 데야.",
