...
(function (root) {
  ...
  ui: {
    ...
    'story.l1intro.1': '어서 와. 오늘부터 여기 사장은 자네야.<br>계약은 한 군데, 창고는 저거 하나. 작게 시작하는 거지.',
    'story.l1intro.2': '저게 오늘 들어온 택배야. 옆에 ⏳ 보이지? 그 안에 보내야 해.',
    'story.l1intro.3': '차는 매일 부르는 게 아니야. 한 대에 {fee}c씩 나가거든.<br>오늘은 그냥 <b>기다려</b>.',
    ...
    'story.l1first.2': '차를 꽉 채울수록 그 몫이 커져. 당분간은 이게 전부야.',
    ...
    'story.l1last.1': '마지막 보름이야. 여기까지 왔으면 이제 혼자 해도 되겠어.',
    'lv.title': '레벨 {n}',
    'lv.doneTitle': '레벨 {n} 완료',
