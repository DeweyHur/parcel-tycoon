...
(function (root) {
  ...
  ui: {
    ...
    'log.refill': '재계약: {name} {n}대 (선금 -{price}c){wasted}',
    'log.refillWasted': ' · 남아 있던 {n}대는 버려짐',
    'mk.refillDesc': '모자란 배차를 다시 계약합니다. 배차비의 절반을 선금으로 내고, 부를 때 나머지 절반만 냅니다.',
    ...
    'cd.refillLine': '재계약 {price}c (마켓 · 배차비 절반 선금)',
    'toast.refill': '재계약: {name} {n}대 — 부를 때 배차비 절반',
    ...
    'story.waitGo.1': '골랐으면 아래 <b>직접 배송</b> 버튼. 그거 나르고 하루가 넘어가.',
    ...
    'story.market2.1': "위에 계약마다 '재계약' 버튼 보이지? 배차비 절반을 선금으로 내면, 부를 때는 나머지 절반만 내. 같은 계열의 더 큰 센터가 나오면 갈아탈 수도 있어 — 담당자도 바뀌고 신뢰도 처음부터지만.<br>창고 확장은 갈수록 비싸지니까 미루지 말고.",
    ...
    'story.l2refill.1': '이게 <b>재계약</b>이야. 쓴 만큼 다시 계약하는 거고, 배차비 절반을 선금으로 내.<br>대신 그 차들은 부를 때 나머지 절반만 내면 돼.',
    'story.l2refill.2': '지금 0이지? 눌러 봐.',
    'story.l2limit.1': '이건 한도를 올리는 거야. 재계약은 그릇을 채우는 거고, 이건 <b>그릇을 키우는 것</b>이지.<br>한 번 사면 계속 남아.',
    ...
    'my.note': '배차는 소모품(월초 리셋 없음, 마켓에서 재계약 — 배차비 절반 선금). 교체 시 잔여 배차·강화 소멸{keep}, 신뢰도는 센터별',
