...
(function (root) {
  ...
  ui: {
    ...
    'story.l1intro.2': "한길 물류 차, 한 번 부르면 <b>{nowFee}c</b>야. 근데 지금 창고엔 {nowVol}칸뿐이라 받는 건 {nowRev}c — <b>{nowLoss}c 손해</b>지.<br>한 칸을 싣든 다 싣든 배차비는 똑같거든. 쌓아 뒀다 꽉 채워 보내는 게 이 일이야. 오늘은 <b>기다려</b>.",
    ...
    'story.l1callPick.1': "한길 물류 여 실장입니다. 저희 차, 한 번 부르면 <b>{nowFee}c</b>예요.<br>위 게이지 보이시죠 — 뒤가 차 한 대에 들어가는 칸, 앞이 지금 실릴 양이에요.",
