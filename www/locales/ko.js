...
(function (root) {
  ...
  ui: {
    ...
    'story.waitGo.1': '골랐으면 오늘 마감. 그거 직접 나른 뒤 오늘 영업을 마감하는 거야.',
    ...
    'story.l3self.2': '배송비가 좀 나가는데 반송보다는 싸. 저 <b>직접 배송</b> 눌러 봐.',
    'story.l3selfPick.1': '급한 것부터 담아 놨어. 작은 것만 돼, 두 칸까지. 상자를 누르면 빼고 넣고.<br>다 됐으면 <b>오늘 마감</b> — 그때 들고 나가.',
