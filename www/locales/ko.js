  ...
  data:   {
    ...
    "CARRIERS": {
      ...
      "intl1": {
        ...
        "short": "보세",
        "vehicle": "보세 트럭",
        "desc": "통관 대기 중인 화물을 즉시 통관·발송. 통관 보너스 · 프리미엄 — 배차 +1·용량 +1·배차비 +20%"
      },
      "intl2": {
        "name": "월드게이트",
        "short": "월드게이트",
        "vehicle": "보세 완충 트럭",
        "desc": "통관 대기 중인 화물을 즉시 통관·발송. 통관 보너스 · 엘리트 — 배차 +2·용량 +2·배차비 +40% · ⚠ 파손 안전 추가"
      },
      "large0": {
        "name": "거인 화물",
        "short": "거인",
      ...
      "large1": {
        ...
        "short": "태산",
        "vehicle": "대형 트럭",
        "desc": "크기 4 이상 택배를 처리 (파손 안전). 대형 보너스 · 프리미엄 — 배차 +1·용량 +1·배차비 +20%"
      },
      "large2": {
        "name": "코끼리 특수운송",
        "short": "코끼리",
        "vehicle": "냉장 대형 트럭",
        "desc": "크기 4 이상 택배를 처리 (파손 안전). 대형 보너스 · 엘리트 — 배차 +2·용량 +2·배차비 +40% · ❄ 냉장 가능 추가"
      },
      "air0": {
        "name": "공항 화물 대리점",
        "short": "공항 대리점",
