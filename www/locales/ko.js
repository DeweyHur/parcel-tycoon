...
(function (root) {
  ...
  ui: {
    ...
    'story.callReady.2': "'급한 순 자동 선택'을 누르면 급한 것부터 담아 줘. 칸이 남으면 하나 더 얹고 넘치면 빼.<br>한 대 더 부르면 배차비도 한 번 더 나가.",
    ...
    'story.rain.1': '비 예보 떴다. 마당에 둔 택배는 젖어서 보상이 20% 깎여. 냉장·냉동은 상관없고.',
    'story.rain.2': '대기 버튼 누르면 적재 화면이 있어 — 뭘 안에 두고 뭘 밖에 둘지 고를 수 있어.<br>비 오는 날은 비싼 걸 안에.',
