...
(function (root) {
  ...
  ui: {
    ...
    'prep.step1': "1/3 단계 — 어느 달력에서, 언제 시작해, 얼마나 굴릴지 고릅니다",
    'btn.title': '타이틀',
    'prep.runWhenSame': "{y1}년 {m1}월 ~ {m2}월",
    'prep.runWhenNext': "{y1}년 {m1}월 ~ {y2}년 {m2}월",
    ...
    'prep.story': '창고장 안내',
    'prep.storyDesc': '박 반장이 첫 3개월 동안 옆에서 규칙을 알려 줍니다 (어느 회사·런이든)',
    'menu.story': '창고장 안내: {v}',
    'menu.sms': '계절 문자: {v}',
    'help.notes': '창고장 노트',
