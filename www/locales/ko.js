...
(function (root) {
  ...
  ui: {
    ...
    'story.market1.2': '카드마다 차 용량·대당 배차비·월 한도가 적혀 있어. 위에 \'다음 달 예상\' 줄 보이지? 어떤 택배가 몇 개쯤 올지야.<br>그걸 보고 부족한 차를 채워.',
    ...
    'story.market2.1': '보유 계약은 \'배차 추가\' 카드가 항상 있어. 창고 확장도 상시.<br>확장은 갈수록 비싸지니까 미루지 말고.',
    ...
    'mk.contractLine': '이번 달 {calls}/{max}대, 차량 {cap}칸',
    'mk.mine': '내 계약',
