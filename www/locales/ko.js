...
(function (root) {
  ...
  ui: {
    ...
    'intro.2': '이 창고에는 주인이 있다. 한종수. 여든둘.',
    'intro.3': '아버지 심부름으로 처음 온 게 열여섯이었다.',
    'intro.4': '그 뒤로는 손이 모자란 날마다 내가 왔다. 짐을 같이 내리고, 국수를 같이 먹고.',
    'intro.skip': '건너뛰기 ▸',
    'intro.5': '작년 겨울에 영감님이 말했다. — “내가 이제 못 들겠어. 자네가 한 해만 굴려 봐.”',
    'intro.6': '“할 만하면 그때 싸게 넘겨주지.” 그래서 오늘부터 열두 달이다.',
    'intro.7': '박 반장님이 두 달만 옆에 붙기로 했다. 오늘이 첫날이다.',
