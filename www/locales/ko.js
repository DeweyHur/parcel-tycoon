...
(function (root) {
  ...
  ui: {
    ...
    'story.l1free.1': "기본은 끝. 쌓이면 부르고, 오늘 할 일이 끝났으면 마감해서 다음 입고를 받아.<br>새로 벌일 건 없어 — 한 사장이 해 온 대로만 하면 돼. 나머지는 자네가 해봐.",
    ...
    'letter.2.good': "차를 꽉 채워 보냈다고 적혀 있네. 배차는 사 두는 것이라 안 쓰면 그냥 사라지네 — 바닥나기 전에 채워 두게.<br><br>한 달 봤으니 말하겠네. 이 창고, 자네한테 넘기겠네. 값과 조건은 서류에 적어 뒀네.<br><br>먼저 간판부터 정하게. 「한성창고」는 내 간판이니.",
    'letter.2.bad': "차가 없어서 못 보낸 게 있었다고. 배차는 사 두는 것이네 — 떨어지면 하루가 통째로 비니 미리 채워 두게.<br><br>그래도 한 달을 끝까지 갔네. 이 창고, 자네한테 넘기겠네. 값과 조건은 서류에 적어 뒀네.<br><br>먼저 간판부터 정하게. 「한성창고」는 내 간판이니.",
    ...
    'letter.1.good': "박 반장한테 들었네. 차를 꽉 채워 보냈다고.<br><br>한 칸을 싣든 다 싣든 배차비는 같으니, 그거 하나면 되네.<br><br>내가 아직 셔터를 못 올리네. 봄만 더 맡아 주게 — 여름 오기 전에 자네한테 할 얘기가 있네.",
    'letter.1.bad': "박 반장한테 들었네. 덜 채워 보낸 게 있었다고.<br><br>급하면 그럴 수 있지. 그래도 배차비는 같으니 채워 보내는 쪽이 늘 남네.<br><br>내가 아직 셔터를 못 올리네. 봄만 더 맡아 주게.",
    'ct.modal': '계약',
    ...
    'ct.body': "위 목적물의 값을 {price}c 로 한다. 오늘 계약금 {down}c 를 받았다.<br>잔금 {rest}c 는 보름마다 한 회차씩, 남은 두 달 안에 나눠 낸다. 이자는 붙이지 않는다.<br>매수인은 들어온 물건을 제 날짜에 내보낼 것. 그것 말고는 조건이 없다.",
    'inst.modal': '잔금',
