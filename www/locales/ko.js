...
(function (root) {
  ...
  ui: {
    ...
    'demo.gateBody': '데모는 인수인계 {n}개월까지 플레이할 수 있습니다. 본편에서는 한국 달력의 봄·여름·가을·겨울, 반기, 한 해 런을 골라 실제 명절과 물가 상승까지 끝까지 운영합니다.',
  ...
  meta:   {
    ...
    "SCENARIOS": {
      ...
      "kr_h1": {
        "name": "상반기 (3~8월)",
        "desc": "봄과 여름을 이어서 — 이사철에서 시작해 장마·폭염을 넘긴다. 점수 ×1.25"
      },
      "kr_h2": {
        "name": "하반기 (9~2월)",
        "desc": "추석에서 설까지. 명절 둘과 연말을 한 판에. 점수 ×1.25"
      },
      "kr_year": {
        "name": "한 해 (3월~이듬해 2월)",
        "desc": "한국 달력 한 바퀴. 고객 신뢰가 오르며 물량이 배로 늘고, 지출도 따라 큰다. 점수 ×1.5"
      }
    },
    "ACHIEVEMENTS": {
      "rookie": {
      ...
      "kr_seasons": {
        "name": "사계절",
        "desc": "한국 분기 런 넷을 모두 완주 → 상반기·하반기 해금"
      },
      "kr_half": {
        "name": "반년 사장",
        "desc": "상반기 또는 하반기 완주 → 한 해 런 해금"
      },
      "kr_year_clear": {
        "name": "한 해를 돌다",
        "desc": "한 해 런 완주"
