...
(function (root) {
  ...
  ui: {
    ...
    'hud.weekend': '일요일',
    'fmt.date': '{cal}월 {t}일차',
    'fmt.dateDow': '{cal}월 {t}일차 ({dow})',
    'fmt.dayN': '{n}일차',
    'fmt.dows': '월,화,수,목,금,토',
    
    'log.weekend': '🛌 {w}주차 일요일 — {choice}{extra}',
  ...
  meta:   {
    ...
    "DIFFICULTIES": {
      "rookie": {
        "name": "수습",
        "desc": "입고 ×0.85, 운영비 -30, 배차비 ×0.8, 가격 ×0.9, 도난·파손·배상 ×0.5, 예정 3일, 스트레스 한계 24. 점수 ×0.7. 해금 도전과제 인정 안 됨"
      },
      "normal": {
        "name": "정규",
    ...
    "SCENARIOS": {
      ...
      "audit": {
        "name": "감사",
        "desc": "모든 기한 -하루, 기한 초과 보상 -50%, 월초 스트레스 +1",
