...
(function (root) {
  ...
  ui: {
    ...
    'intro.3': '한종수. 여든둘. 마흔에 리어카 한 대로 시작했다고 했다.',
    ...
    'intro.11': '오늘이 첫날이다.',
    'card.han.name': '한종수',
    'card.han.desc': '이 창고의 주인 · 여든둘',
    'card.park.name': '박 반장',
    'card.park.desc': '이 창고 반장 · 스무 해',
    'intro.skip': '건너뛰기 ▸',
    ...
    'story.l1mart.1': '큰마트에서 나왔습니다. 오늘부터 물건 이쪽으로 보냅니다.<br>기한만 지켜 주시면 계속 맡길게요.',
    'story.l1mart.2': '우리 단골이야. 지금은 저 집 물건이 거의 전부고.<br>잘 보내 주면 계속 보내 줘 — 그게 이 장사야.',
    ...
    'ps.noDeadline': '기한 없음',
    'story.l1due.1': '이번 주부터는 급한 것도 같이 보냅니다.<br>날짜 적힌 건 그 안에 나가야 해요.',
    'story.l1due.2': '보이지? 이제 ⏳ 가 붙어. 저 숫자가 남은 날이야.<br>지금까진 급한 게 없어서 안 붙었던 거고.',
    ...
    'ct.modal': '계약',
    'ct.title': '창 고 매 매 계 약 서',
    'ct.seller': '매도인',
    'ct.sellerName': '한종수',
    'ct.buyer': '매수인',
    'ct.item': '목적물',
    'ct.itemName': '동네 창고 1동 · 부속 마당',
    'ct.body': '위 매도인은 목적물을 매수인에게 넘긴다. 값은 이미 한 해 동안 몸으로 치렀다.<br>매수인은 들어온 물건을 제 날짜에 내보낼 것. 그것 말고는 조건이 없다.',
    'ct.stamp': '도장 찍기',
    'ct.stampMark': '韓',
    'ct.done': '창고를 넘겨받는다',
    'lv.ch.1': '서장',
    ...
    'lv.nameBody': '한 해를 다 굴렸네. 이제 내 창고가 아니라 자네 창고야.<br>계약서에 뭐라고 적을까?',
