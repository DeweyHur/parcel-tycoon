...
(function (root) {
  ...
  ui: {
    ...
    'story.l3intro.3': '그리고 이번 달부터 차가 하나 더 붙어. <b>살살 택배</b> — 작은 완충 밴이야.<br>깨지는 것(⚠)도 받고 일반도 받는데, 4칸짜리라 일반만 실으면 남는 게 없어.',
    ...
    'story.l4intro.1': '사월 후반이면 이사철이 한창이야. 오는 물건이 또 달라져.<br>깨지는 건 봤지? 이제 <b>상하는 것</b>도 와.',
