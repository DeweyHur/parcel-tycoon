...
(function (root) {
  ...
  ui: {
    ...
    'story.l1callPick.1': "한길 물류 여 실장입니다. 저희 차, 한 번 부르면 <b>{nowFee}c</b>예요.<br>이 차 그림이 저희 차 한 대예요. 색칠된 칸이 지금 실릴 짐이고요.",
    'story.l1callPick.2': "급한 것부터 차가 차는 만큼 <b>이미 담아 놨어</b>. 아래 창고 상자를 누르면 빼고 넣을 수 있고.<br>이대로 보내면 돼. 호출하면 그대로 하루가 지나가.",
