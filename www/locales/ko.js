...
(function (root) {
  ...
  ui: {
    ...
    'story.usage76.2': "위에 저 줄 보이지? <b>내일·모레</b> 뭐가 얼마나 오는지야.<br>그걸 보고 오늘 마감할지 차를 부를지 정해.",
    ...
    'story.l1intro.2': "한길 물류 차는 한 번 부르면 <b>{nowFee}c</b>야. 한 개를 싣든 꽉 채우든 똑같이 {nowFee}c.<br>지금 창고엔 {nowCount}개 있고, 그거 다 실어 보내 봐야 <b>{nowRev}c</b> 받아.<br>{nowRev}c 받자고 {nowFee}c 내면 <b>{nowLoss}c 손해</b>지. 그래서 오늘은 <b>기다려</b>.",
    'story.l1call.1': '이제 부를 만해. 저 버튼에 <b>{readyVol}/{readyCap}칸</b>.',
    'story.l1call.2': "지금 부르면 <b>{nowRev}c</b> 받고 배차비 {nowFee}c — <b>{nowNet}c 남아.</b><br>첫날이랑 같은 {nowFee}c야. 쌓아 뒀다 한 번에 보내니까 남는 거지. 눌러 봐.",
