...
(function (root) {
  ...
  ui: {
    ...
    'media.trait.flyer': "일반 택배 위주",
    'media.trait.sns': "신선·농산물↑",
    'media.trait.radio': "고르게",
    'media.trait.bus': "대형·파손주의↑",
    'media.line': "{days}일 안에 +{n}건 · 집행 {cost}c",
    'media.upLine': "+{n}건 → +{n2}건 · 집행 {cost}c → {cost2}c",
    'media.newHead': "광고",
    'media.run': "집행",
    'media.more': "새 매체와 강화는 마켓에서",
    'growth.fleet': "차량",
    'growth.warehouse': "창고",
