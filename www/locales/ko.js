...
(function (root) {
  ...
  ui: {
    ...
    'story.l1intro.4': '저게 오늘 들어온 거야. 창고는 하루도 안 쉬고 차.',
    'story.l1intro.5': '한길 물류 여 실장입니다. 새로 맡으셨다고요?<br>차 필요하시면 부르세요 — 지금은 저희가 유일한 계약이라.',
    'story.l1intro.6': '봤지? 부르면 와. 대신 한 번 부를 때마다 돈이 나가.<br>그러니 오늘은 부르지 마. 쌓아 뒀다가 꽉 채워 보내는 게 이 일이야. 오늘은 <b>기다려</b>.',
    ...
    'story.l1intro.1': '왔구만. 영감님한테 얘기 들었어.<br>오늘부터 자네가 굴린다고.',
    'story.l1intro.2': '나는 박 반장이야. 여기서 물건 받고 내보내는 거, 스무 해 했고.',
    'story.l1intro.3': '영감님이 자네 옆에 좀 붙어 있으라대.<br>나야 갈 데도 없고 — 올해는 계속 같이 하는 거야.',
    'story.l1waitGo.1': '여기서 <b>그냥 대기</b>를 눌러.',
    'story.l1call.1': '이제 부를 만해. 저 버튼에 <b>{readyVol}/{readyCap}칸</b>이라고 적혀 있지?',
    'story.l1call.2': '차 한 대가 {readyCap}칸이야. 꽉 채울수록 택배 한 개당 값이 싸져. 눌러 봐.',
