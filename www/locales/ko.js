...
(function (root) {
  ...
  ui: {
    ...
    'intro.2': '스무 해 굴러온 창고 하나가 이번 달로 문을 닫는다.',
    'intro.3': '주인은 접자고 했고, 나는 해보겠다고 했다.',
    'intro.4': '오늘이 첫날이다.',
    'intro.skip': '건너뛰기 ▸',
    'story.name.mart': '큰마트 김 대리',
    'story.l1intro.4': '저게 오늘 들어온 거야. 창고는 하루도 안 쉬고 차.',
    'story.l1intro.5': '한길 물류 여 실장입니다. 새 사장님이시죠?<br>차 필요하시면 부르세요 — 지금은 저희가 유일한 계약이라.',
    ...
    'story.l1last.2': '이 창고, 아직 이름이 없어. 전 주인 간판은 떼 버렸거든.<br>이번 달만 넘기면 하나 붙여 봐.',
    'story.l1intro.1': '왔구만. 첫날인데 안 늦었네.<br>나는 박 반장이야. 여기 창고장… 이었고.',
    'story.l1intro.2': '이 창고, 오늘부터 자네 거야.<br>나는 여기서 스무 해를 굴렀는데 이번 달로 정년이거든.',
    'story.l1intro.3': '주인은 문 닫자고 했어. 자네가 해보겠다길래 내가 우겼지.<br>대신 두 달만 옆에서 봐 주기로 하고.',
    ...
    'lv.nameAsk': '이제 이름을 붙일 때야',
    'lv.nameBody': '두 달을 굴려 봤으니 이제 자네 가게지. 간판에 뭐라고 쓸까?',
